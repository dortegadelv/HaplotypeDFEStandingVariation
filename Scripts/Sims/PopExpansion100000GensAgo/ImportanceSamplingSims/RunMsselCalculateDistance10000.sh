...
File="../../../../Results/PopExpansion100000GensAgo/ImportanceSamplingSims/ExitMssel_0.01_0_"$FileNumber".txtTrajectory.txt"
ExitMssel="../../../../Results/PopExpansion100000GensAgo/ImportanceSamplingSims/TrajParTrajPartMsselOut_"$FileNumber"_"$Repetition".txt"
MsselFile="../../../../Results/PopExpansion100000GensAgo/ImportanceSamplingSims/MsselFileOut_"$FileNumber"_"$Repetition".txt"
DistancesFile="../../../../Results/PopExpansion100000GensAgo/ImportanceSamplingSims/DistancesFile10000_"$FileNumber"_"$Repetition".txt"
...
# for k in {1..1000}
# do
../../../../Programs/Mssel/mssel3 41 100 1 40 $ExitMssel 1 -r 500 250000 -t 600 -eN 0.0 1.0 -eN 0.5 0.1 -seeds $SeedNumber $SeedNumber $SeedNumber > $MsselFile
# done
