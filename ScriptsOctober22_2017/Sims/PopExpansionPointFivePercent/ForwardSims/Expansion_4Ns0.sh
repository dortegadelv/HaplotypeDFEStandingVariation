...
#$ -N ForWF
#$ -o ../../../../Results/PopExpansionPointFivePercent/ForwardSims/4Ns_0/Trash
#$ -e ../../../../Results/PopExpansionPointFivePercent/ForwardSims/4Ns_0/Trash
...
time perl ../../ConstantPopSize/ForwardSims/GetListOfRunsWhereFrequencyMatches.pl 0.005 0.005 ../../../../Results/PopExpansionPointFivePercent/ForwardSims/4Ns_0/Output.$SGE_TASK_ID.full_out.txt ../../../../Results/PopExpansionPointFivePercent/ForwardSims/4Ns_0/Alleles_$SGE_TASK_ID.txt 0 80100

File="../../../../Results/PopExpansionPointFivePercent/ForwardSims/4Ns_0/Output."$SGE_TASK_ID".full_out.txt"
