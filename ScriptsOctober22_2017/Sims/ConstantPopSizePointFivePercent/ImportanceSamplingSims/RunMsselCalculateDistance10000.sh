...
File="../../../../Results/ConstantPopSizePointFivePercent/ImportanceSamplingSims/ExitMssel_0.005_0_"$FileNumber".txtTrajectory.txt"
ExitMssel="../../../../Results/ConstantPopSizePointFivePercent/ImportanceSamplingSims/TrajParTrajPartMsselOut_"$FileNumber"_"$Repetition".txt"
MsselFile="../../../../Results/ConstantPopSizePointFivePercent/ImportanceSamplingSims/MsselFileOut_"$FileNumber"_"$Repetition".txt"
DistancesFile="../../../../Results/ConstantPopSizePointFivePercent/ImportanceSamplingSims/DistancesFile10000_"$FileNumber"_"$Repetition".txt"
