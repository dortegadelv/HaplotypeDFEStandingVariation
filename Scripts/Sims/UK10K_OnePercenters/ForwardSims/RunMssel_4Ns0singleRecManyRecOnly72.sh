...
DistancesFile="../../../../Results/UK10K/ForwardSims/4Ns_0/SimDistancesMsselSingleRecHighRecOnly72"${NumberOfMarkers[3]}"_"${RecRate[$RecNumber]}"_"$Repetition".txt"
rm $DistancesFile
touch $DistancesFile
...
DistancesFileTemp="../../../../Results/UK10K/ForwardSims/4Ns_0/SimDistancesMsselSingleRecHighRecOnly72Temp"${NumberOfMarkers[3]}"_"${RecRate[$RecNumber]}"_"$Repetition".txt"

perl ../../ConstantPopSize/ForwardSims/SampleTrajectories.pl ../../../../Results/UK10K/ForwardSims/4Ns_0/ReducedTrajectories_72.txt 275 $ResampledTrajFile $Repetition
