...
File="../../../../Results/PopExpansionYRI/ImportanceSamplingSims/ExitMssel_0.01_0_"$FileNumber".txtTrajectory.txt"
ExitMssel="../../../../Results/PopExpansionYRI/ImportanceSamplingSims/TrajParTrajPartMsselOut_"$FileNumber"_"$Repetition".txt"
MsselFile="../../../../Results/PopExpansionYRI/ImportanceSamplingSims/MsselFileOut_"$FileNumber"_"$Repetition".txt"
DistancesFile="../../../../Results/PopExpansionYRI/ImportanceSamplingSims/DistancesFile10000_"$FileNumber"_"$Repetition".txt"
...
for i in {1..1000}
do
perl ../../ConstantPopSize/ImportanceSamplingSims/TrajectoryPartMssel.pl $File $i $ExitMssel 330000
...
# for k in {1..1000}
# do
../../../../Programs/Mssel/mssel3 41 100 1 40 $ExitMssel 1 -r 660 100000 -t 792 -eN 0.0 1.0 -eN 0.00030303 0.1 -eN 0.005050505 0.3 -eN 0.02020202 0.1 -seeds $SeedNumber $SeedNumber $SeedNumber > $MsselFile
# done
