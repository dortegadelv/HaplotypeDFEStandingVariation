...
$SynNumberFile = "../../../../Data/VariantNumberPointFiveToIncludeSynonymous.txt";
...
$SynNumberFile = "../../../../Data/VariantNumberPointFiveToInclude.txt";
open (SYNN,$SynNumberFile) or die "NO!";
while(<SYNN>){
chomp;
$Line = $_;
...
print "Number = $SynN\n";
$File = "../../../../Data/Plink/HapLengthsPointFive/HapLengthPoint5Synonymous".$SynN.".txt";
...
for $MisN (@MisNumbers){
print "Number = $MisN\n";
$File = "../../../../Data/Plink/HapLengthsPointFive/HapLengthPoint5".$MisN.".txt";
open (DIST,$File) or die "NO!";
