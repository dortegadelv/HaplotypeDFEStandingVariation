$ExitFile = "../../../../Results/ConstantPopSize/ImportanceSamplingSims/SumDistancesFileBothSides10000.txt";
...
for ( $k = 1; $k <= 1; $k++ ){
$InputFile = "../../../../Results/ConstantPopSize/ImportanceSamplingSims/DistancesFileBothSides10000_".$j."_".$k.".txt";
