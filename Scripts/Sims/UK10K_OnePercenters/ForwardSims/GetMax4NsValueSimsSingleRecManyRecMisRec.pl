...
for ( $MisNumber = 9; $MisNumber <= 13 ; $MisNumber++ ) {
# for ( $RecNumber = 0; $RecNumber < 20 ; $RecNumber++ ) {

print "$FourNs[$DirNumber]\n";
$ExitFile = "../../../../Results/ResultsSelectionInferred/SelectionUK10K".$MisNumber."SmallRec".$FourNsNumber[$DirNumber].".txt";
open (EXIT,">$ExitFile") or die "NO";
for ( $RepNumber = 1; $RepNumber <= 50 ; $RepNumber++) {
# LLSimsSingleRecHighRecMssel273_"${RecRate[$RecNumber]}"_"$RepNumber".txt"
$File="../../../../Results/UK10K/ForwardSims/".$FourNs[$DirNumber]."/LLSimsSingleRecHighRecMssel273_".$RecRate[$RecNumber]."_".$MisNumber."_".$RepNumber.".txt";
