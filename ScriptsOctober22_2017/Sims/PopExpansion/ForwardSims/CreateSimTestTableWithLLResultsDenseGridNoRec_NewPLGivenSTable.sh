...
Directory="../../../../Results/PopExpansion/ForwardSims/"${FourNs[$SGE_TASK_ID]}"/"
for k in {3..3}
do
ResultsFile="../../../../Results/PopExpansion/ForwardSims/"${FourNs[$SGE_TASK_ID]}"/HapLengths/ExitFileNoRecN"${NumberOfMarkers[$k]}".txt"
rm $ResultsFile
for j in {1..100}
do
HapFile="../../../../Results/PopExpansion/ForwardSims/"${FourNs[$SGE_TASK_ID]}"/HapLengths/HapLengths"$j".txt"
