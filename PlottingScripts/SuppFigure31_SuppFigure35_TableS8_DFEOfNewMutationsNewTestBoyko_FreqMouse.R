...
pdf("../Figures/SuppFigure31_UK10KDFE_Boyko.pdf",width=19)
par(mar=c(5.1,5.1,4.1,2.1))
...
ViridisColors <- viridis(3, alpha = 0.7)
pdf("../Figures/SuppFigure31_BarPlot_UK10KDFE_StandingNew_OnlyThreeBins_NaturalScale.pdf",width=19)
par(mar=c(5.1,5.1,4.1,2.1))
...
ViridisColors <- viridis(3, alpha = 0.7)
pdf("../Figures/SuppFigure35_DensityPlot_UK10KDFE_StandingNew_OnlyThreeBins_NaturalScaleHighPop.pdf",width=19)
...
ViridisColors <- viridis(3, alpha = 0.7)
pdf("../Figures/SuppFigure31_DensityPlot_UK10KDFE_StandingNew_OnlyThreeBins_NaturalScale.pdf",width=19)
