$ExitFile = "../../../../Results/PopExpansion/ImportanceSamplingSims/SumDistancesFile10000_NoRec.txt";
...
for ( $k = 1; $k <= 1; $k++ ){
$InputFile = "../../../../Results/PopExpansion/ImportanceSamplingSims/DistancesFile10000_NoRec_".$j."_".$k.".txt";
