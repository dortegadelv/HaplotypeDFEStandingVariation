...
time GSL_RNG_SEED=$SLURM_ARRAY_TASK_ID GSL_RNG_TYPE=mrg ../../../../Programs/PReFeRSim/fwd_seldist_gsl_2012_4epoch.debug ParameterFile_DFE.txt $SLURM_ARRAY_TASK_ID
...
ParameterFile="ParameterFile_DFE_"$i"_B.txt"

time perl ../../ConstantPopSize/ForwardSims/GetListOfRunsWhereFrequencyMatches.pl ${LowFreq[$i]} ${UpFreq[$i]} ../../../../Results/UK10K/ForwardSims/DFETest/Output.$SLURM_ARRAY_TASK_ID.full_out.txt ../../../../Results/UK10K/ForwardSims/DFETest/$AlleleFile 0 24834

File="../../../../Results/UK10K/ForwardSims/DFETest/Output."$SLURM_ARRAY_TASK_ID".full_out.txt"
