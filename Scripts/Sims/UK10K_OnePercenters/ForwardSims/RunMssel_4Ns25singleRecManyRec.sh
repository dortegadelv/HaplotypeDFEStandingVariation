...
DistancesFile="../../../../Results/UK10K/ForwardSims/4Ns_25/SimDistancesMsselSingleRecHighRec"${NumberOfMarkers[3]}"_"${RecRate[$RecNumber]}"_"$Repetition".txt"
rm $DistancesFile
touch $DistancesFile
...
DistancesFileTemp="../../../../Results/UK10K/ForwardSims/4Ns_25/SimDistancesMsselSingleRecHighRecTemp"${NumberOfMarkers[3]}"_"${RecRate[$RecNumber]}"_"$Repetition".txt"

perl ../../ConstantPopSize/ForwardSims/SampleTrajectories.pl ../../../../Results/UK10K/ForwardSims/4Ns_25/ReducedTrajectories_$i.txt ${Samples[$i]} $ResampledTrajFile $Repetition
