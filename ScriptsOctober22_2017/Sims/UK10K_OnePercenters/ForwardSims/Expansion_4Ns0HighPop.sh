...
time GSL_RNG_SEED=$SGE_TASK_ID GSL_RNG_TYPE=mrg ../../../../Programs/PReFeRSim/fwd_seldist_gsl_2012_4epoch.debug ParameterFile_4Ns0HighPop.txt $SGE_TASK_ID

time perl ../../ConstantPopSize/ForwardSims/GetListOfRunsWhereFrequencyMatches.pl 0.0095 0.0105 ../../../../Results/UK10KHighPopSize/ForwardSims/4Ns_0/Output.$SGE_TASK_ID.full_out.txt ../../../../Results/UK10KHighPopSize/ForwardSims/4Ns_0/Alleles_$SGE_TASK_ID.txt 0 24834

File="../../../../Results/UK10KHighPopSize/ForwardSims/4Ns_0/Output."$SGE_TASK_ID".full_out.txt"

rm $File

time GSL_RNG_SEED=$SGE_TASK_ID GSL_RNG_TYPE=mrg ../../../../Programs/PReFeRSim/fwd_seldist_gsl_2012_4epoch.debug ParameterFile_4Ns0HighPop_B.txt $SGE_TASK_ID
