...
time perl ../../ConstantPopSize/ForwardSims/GetListOfRunsWhereFrequencyMatches.pl 0.01 0.01 ../../../../Results/ConstantPopSizeBoyko/ForwardSims/Output.$SGE_TASK_ID.full_out.txt ../../../../Results/ConstantPopSizeBoyko/ForwardSims/Alleles_$SGE_TASK_ID.txt 0 160000

File="../../../../Results/ConstantPopSizeBoyko/ForwardSims/Output."$SGE_TASK_ID".full_out.txt"
