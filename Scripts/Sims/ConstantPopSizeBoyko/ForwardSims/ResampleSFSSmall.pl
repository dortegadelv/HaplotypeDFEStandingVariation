...
$FileNumber++;
$RandomNumber = $j;
$InputFile = $Directories[$i]."OutputSmall.".$RandomNumber.".sfs.txt";
...
$OutputResampled = $Directories[$i]."OutputSmall.".$j.".resampledsfs.txt";
$OutputFileNumber = $Directories[$i]."OutputSmall.".$j.".numberfileresampledsfs.txt";
