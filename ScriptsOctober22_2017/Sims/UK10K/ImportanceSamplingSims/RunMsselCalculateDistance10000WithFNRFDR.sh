...
# for k in {1..1000}
# do
../../../../Programs/Mssel/mssel3 3 1000 1 2 $ExitMssel 1 -r 0.0 250000 -t 2601.63 -eN 0.0 1.0 -eN 0.0000867 0.1291653 -eN 0.0001768 0.0421744 -eN 0.0013261 0.0107298 -eN 0.0029405 0.0834516 -eN 0.0085331 0.0420890 -seeds $SeedNumber $SeedNumber $SeedNumber > $MsselFile
# done
time perl DistanceToFirstSegregatingSiteWithFDRFNR.pl $MsselFile $DistancesFile 250000 TestT2Bounds.txt 0.000007
else
