...
open (EXCLUSION,"../../../../Data/VariantNumberPointFiveSynonymous.txt") or die "NO!";
open (PERRECVAR,">../../../../Data/LeftBpRecRatePerVariantSynonymousPointFive.txt") or die "NO!";
@VariantsToExclude = ();
...
$GeneticMapFile = "../../../../Data/Plink/SynonymousPointFivePercent".$i.".frq";
...
if ( $ACTMAPLineNumber == ( $LastPositionACTMAP ) ){
$CurRegionPosition = $SplitLine[0];
$CurRegionGenMap = $SplitLine[1];
$GenMapRate = ($CurRegionGenMap - $PreRegionGenMap) / ($CurRegionPosition - $PreRegionPosition);
# print "$Line\n";
...
open (PERRECVAR,">../../../../Data/RightBpRecRatePerVariantSynonymousPointFive.txt") or die "NO!";
