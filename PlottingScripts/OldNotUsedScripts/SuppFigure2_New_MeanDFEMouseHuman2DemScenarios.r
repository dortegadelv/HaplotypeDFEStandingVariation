...
beanplot(-FourNsMeans,main="Constant Boyko",ylab="Mean 4Ns value",cex.lab=1.5,ylim=c(-200,10),cex.axis=1.5, cex.main=1.5, col = c("#CAB2D6", "#33A02C", "#B2DF8A"), border = "#CAB2D6", maxstripline=0.15, beanlinewd=0.5, overall=10000, what=c(FALSE,TRUE,TRUE,TRUE), overallline = "median", ll=0.5)
...
beanplot(-FourNsMeans,main="Constant Mouse",ylab="Mean 4Ns value",cex.lab=1.5,ylim=c(-200,10),cex.axis=1.5, cex.main=1.5,col = c("#CAB2D6", "#33A02C", "#B2DF8A"), border = "#CAB2D6", maxstripline=0.15, beanlinewd=0.5, overall=10000, what=c(FALSE,TRUE,TRUE,TRUE), overallline = "median", ll=0.5)
...
beanplot(-FourNsMeans,main="Pop expansion Boyko",ylab="Mean 4Ns value",cex.lab=1.5,ylim=c(-200,10),cex.axis=1.5, cex.main=1.5, col = c("#CAB2D6", "#33A02C", "#B2DF8A"), border = "#CAB2D6", maxstripline=0.15, beanlinewd=0.5, overall=10000, what=c(FALSE,TRUE,TRUE,TRUE), overallline = "median", ll=0.5)
...
beanplot(-FourNsMeans,main="Pop expansion Mouse",ylab="Mean 4Ns value",cex.lab=1.5,ylim=c(-200,10),cex.axis=1.5, cex.main=1.5, col = c("#CAB2D6", "#33A02C", "#B2DF8A"), border = "#CAB2D6", maxstripline=0.15, beanlinewd=0.5, overall=10000, what=c(FALSE,TRUE,TRUE,TRUE), overallline = "median", ll=0.5)
