...
ExitMssel="../../../../Results/ConstantPopSize/ImportanceSamplingSims/TrajParTrajPartMsselOut_10Windows_"$FileNumber"_"$Repetition".txt"
MsselFile="../../../../Results/ConstantPopSize/ImportanceSamplingSims/MsselFileOut_10Windows_"$FileNumber"_"$Repetition".txt"
DistancesFile="../../../../Results/ConstantPopSize/ImportanceSamplingSims/DistancesFile10000_10Windows_"$FileNumber"_"$Repetition".txt"
