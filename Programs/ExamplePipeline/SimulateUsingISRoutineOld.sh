...
time ./FoIS -A $HomozygoteFitness -a $HeterozygoteFitness -f $PresentDayAlleleFrequency -r $Replicates -N $PresentDayChromosomes -s $Identifier -F $ExitPrefix -b Bounds.txt -D $FoISDemScenario -X $SelValuesForwardFile -p $SampleSize
