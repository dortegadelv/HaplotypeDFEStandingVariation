$ExitFile = "../../../../Results/PopExpansionBoykoPlusPositive/ImportanceSampling/SumDistancesFile10000.txt";
...
for ( $k = 1; $k <= 1; $k++ ){
$InputFile = "../../../../Results/PopExpansionBoykoPlusPositive/ImportanceSampling/DistancesFile10000_".$j."_".$k.".txt";
