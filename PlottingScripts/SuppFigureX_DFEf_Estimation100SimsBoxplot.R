...
Expression <- expression(paste("5% and 95% percentile of the inferred P(",bolditalic(s[j])," | 1%, DFE, D)"))
Expression2 <- expression(paste("P(",bolditalic(s[j])," | 1%, DFE, D)"))
...
plot(1:DivisionsPlusOne,c(Probabilities_At_One_Percent_Given_2NsMouse[1:Divisions], 1 - sum(Probabilities_At_One_Percent_Given_2NsMouse[1:Divisions])), col=ColorViridis[1], ylim=c(0,1.0), xaxt="n", ylab="Probability", xlab="4Ns",lwd=5,cex.lab=2,cex.axis=2,cex.lab=2, main = "A) Constant size - Mouse DFE",cex.main = 2)
