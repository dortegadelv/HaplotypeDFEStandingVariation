...
echo ${Directory[$i]}
CurrentFile="../../../Results/"${Directory[$i]}"/ForwardSims/"${FourNs[$j]}"/ReducedTrajectories99Percent_72.txt"
TTwosFile="../../../Results/TTwos/TTwos"${Directory[$i]}"_"${FourNs[$j]}".txt"
ExitDir="../../../Results/"${Directory[$i]}"/ForwardSims/"${FourNs[$j]}"/Trajectories99Percent"
...
for k in {1..1}
do
perl SampleTrajectories.pl $CurrentFile 472 $ExitDir $k $DemHist
done

TrajFile="../../../Results/"${Directory[$i]}"/ForwardSims/"${FourNs[$j]}"/Trajectories/Traj_"
ExitT2File="../../../Results/TTwos/99Percent"${Directory[$i]}"_"${FourNs[$j]}".txt"
