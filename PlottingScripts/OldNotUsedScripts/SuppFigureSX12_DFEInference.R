...
AllPartTwo <- c(PartTwo[1:20],1-sum(PartTwo[1:20]))
...
points(Divisions*4 + 2.5, max(0, log10(Quantiles[1]) - log10(0.0000000001)), col="black", pch=24, bg = "black", cex=1)
...
points(Divisions*4 + 3.5, max(0, log10(Quantiles[1]) - log10(0.0000000001)), col="black", pch=24, bg = "black", cex=1)
...
barplot(log10(counts) - log10(0.0000000001), main="B) Simulation Replicate 2", ylab="Probability", xlab=expression(bolditalic(s[j]) * " (4Ns intervals)"), col=ViridisColors, legend = c(expression("Real" ~ 'P'[psi] * "(" * bolditalic(s[j]) * ")"), expression("Inferred"  ~ 'P'[psi] * "(" * bolditalic(s[j]) * ")"), expression('P'[psi] * "(" * bolditalic(s[j]) * " | "* italic(f) * ", "* italic(D) *")")), beside=TRUE, cex.lab=2, cex.axis=2,cex.names=2, args.legend = list(x = "top",cex=1.5, bty = "n"), cex.main = 2, ylim = c(0,12), yaxt="n")
...
points(Divisions*4 + 2.5, max(0, log10(Quantiles[1]) - log10(0.0000000001)), col="black", pch=24, bg = "black", cex=1)
points(Divisions*4 + 2.5, log10(Quantiles[2]), col="black", pch=25, bg = "black", cex=1)
points(Divisions*4 + 2.5, log10(CurrentMean) - log10(0.0000000001), col="black", pch=8, bg = "black", cex=1)
...
barplot(log10(counts) - log10(0.0000000001), main="C) Simulation Replicate 3", ylab="Probability", xlab=expression(bolditalic(s[j]) * " (4Ns intervals)"), col=ViridisColors, legend = c(expression("Real" ~ 'P'[psi] * "(" * bolditalic(s[j]) * ")"), expression("Inferred"  ~ 'P'[psi] * "(" * bolditalic(s[j]) * ")"), expression('P'[psi] * "(" * bolditalic(s[j]) * " | "* italic(f) * ", "* italic(D) *")")), beside=TRUE, cex.lab=2, cex.axis=2,cex.names=2, args.legend = list(x = "top",cex=1.5, bty = "n"), cex.main = 2, ylim = c(0,12), yaxt="n")
...
barplot(log10(counts) - log10(0.0000000001), main="D) Simulation Replicate 4", ylab="Probability", xlab=expression(bolditalic(s[j]) * " (4Ns intervals)"), col=ViridisColors, legend = c(expression("Real" ~ 'P'[psi] * "(" * bolditalic(s[j]) * ")"), expression("Inferred"  ~ 'P'[psi] * "(" * bolditalic(s[j]) * ")"), expression('P'[psi] * "(" * bolditalic(s[j]) * " | "* italic(f) * ", "* italic(D) *")")), beside=TRUE, cex.lab=2, cex.axis=2,cex.names=2, args.legend = list(x = "top",cex=1.5, bty = "n"), cex.main = 2, ylim = c(0,12), yaxt="n")
...
TotalDifferences <- matrix(nrow=400,ncol=21)
for (i in 1:400){
    for (j in 1:21){
