...
# TrajNum=$( wc -l ../../../../Results/UK10K/ForwardSims/4Ns_50/Alleles{1..1000}.txt | tail -n1 | awk '{print $1}' )
# echo $TrajNum
...
Fractions[69]="0.01424"
Fractions[70]="0.01466"
Fractions[71]="0.01514"
Fractions[72]="0.01500"
Fractions[73]="0.01551"
Fractions[74]="0.01493"
Fractions[75]="0.01551"
Fractions[76]="0.01579"


ResampledTrajFile="../../../../Results/UK10K/ForwardSims/4Ns_50/ResampledTraj"$SLURM_ARRAY_TASK_ID".txt"
MsselOut="../../../../Results/UK10K/ForwardSims/4Ns_50/MsselOut"$SLURM_ARRAY_TASK_ID".txt"
HapLengths="../../../../Results/UK10K/ForwardSims/4Ns_50/HapLength"$SLURM_ARRAY_TASK_ID".txt"
MsselOutNoRec="../../../../Results/UK10K/ForwardSims/4Ns_50/MsselOutNoRec"$SLURM_ARRAY_TASK_ID".txt"
HapLengthsNoRec="../../../../Results/UK10K/ForwardSims/4Ns_50/HapLengthNoRec"$SLURM_ARRAY_TASK_ID".txt"
MsselOutNoRecAnc="../../../../Results/UK10KForwardSims/4Ns_50/MsselOutNoRecAnc"$SLURM_ARRAY_TASK_ID".txt"
HapLengthsNoRecAnc="../../../../Results/UK10K/ForwardSims/4Ns_50/HapLengthNoRecAnc"$SLURM_ARRAY_TASK_ID".txt"

MsselOutMultiSeq="../../../../Results/UK10K/ForwardSims/4Ns_50/MsselOutMultiSeq"$SLURM_ARRAY_TASK_ID".txt"
HapLengthsMultiSeq="../../../../Results/UK10K/ForwardSims/4Ns_50/HapLengthMultiSeq"$SLURM_ARRAY_TASK_ID".txt"
T2File="../../../../Results/UK10K/ForwardSims/4Ns_50/T2Values"$SLURM_ARRAY_TASK_ID".txt"
...
# cat ../../../../Results/UK10K/ForwardSims/4Ns_50/TrajMsselLike.txt | ../stepftn > ../../../../Results/UK10K/ForwardSims/4Ns_50/ReducedTrajectories10000.txt
...
HapLengths="../../../../Results/UK10K/ForwardSims/4Ns_50/HapLengthN"${NumberOfMarkers[$i]}"_"$Reps".txt"
HapLengthsNoRec="../../../../Results/UK10K/ForwardSims/4Ns_50/HapLengthNoRecN"${NumberOfMarkers[$i]}"_"$Reps".txt"
HapLengthsMultiSeq="../../../../Results/UK10K/ForwardSims/4Ns_50/HapLengthMultiSeqN"${NumberOfMarkers[$i]}"_"$Reps".txt"
HapLengthsNoRecAnc="../../../../Results/UK10K/ForwardSims/4Ns_50/HapLengthNoRecAncN"${NumberOfMarkers[$i]}"_"$Reps".txt"
HapLengthsRecAware="../../../../Results/UK10K/ForwardSims/4Ns_50/HapLengthRecAwareN"${NumberOfMarkers[$i]}"_"$Reps".txt"
DistancesFileOne="../../../../Results/UK10K/ForwardSims/4Ns_50/SimDistancesPartOneMisAncMssel"${NumberOfMarkers[$i]}"_"$Reps".txt"
DistancesFileTwo="../../../../Results/UK10K/ForwardSims/4Ns_50/SimDistancesPartTwoMisAncMssel"${NumberOfMarkers[$i]}"_"$Reps".txt"
DistancesFile="../../../../Results/UK10K/ForwardSims/4Ns_50/SimDistancesMisAncMssel"${NumberOfMarkers[$i]}"_"$Reps".txt"
SamplesFile="../../../../Results/UK10K/ForwardSims/4Ns_50/SamplesToCheckMssel"${NumberOfMarkers[$i]}"_"$Reps".txt"
...
for ChrNum in {69..76}
do
Value[$ChrNum]=$( grep 'age' ../../../../Results/UK10K/ForwardSims/4Ns_50/ReducedTrajectories_$ChrNum.txt | wc -l )
done
...
perl ../../ConstantPopSize/ForwardSims/SampleTrajectories.pl ../../../../Results/UK10K/ForwardSims/4Ns_50/ReducedTrajectories_$ChrNum.txt 1 $ResampledTrajFile $RandomSeed
...
CurTrajNumber=$( grep 'age' ../../../../Results/UK10K/ForwardSims/4Ns_50/ReducedTrajectories99Percent_$ChrNum.txt | wc -l )

perl ../../ConstantPopSize/ForwardSims/SampleTrajectoriesAncMisspecified.pl ../../../../Results/UK10K/ForwardSims/4Ns_50/ReducedTrajectories99Percent_$ChrNum.txt 1 $ResampledTrajFile $RandomSeed 164462 $CurTrajNumber
...
# perl ../../ConstantPopSize/ForwardSims/SampleTrajectories.pl ../../../../Results/UK10K/ForwardSims/4Ns_50/ReducedTrajectories99Percent_$ChrNum.txt 1 $ResampledTrajFile $RandomSeed
