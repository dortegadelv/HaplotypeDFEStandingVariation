...
# for k in {1..1000}
# do
../../../../Programs/Mssel/mssel3 41 100 1 40 $ExitMssel 1 -r 0.0 250000 -t 604.920000000000000 -eN 0.0 1.0 -eN .000570323348541 .096260662566951 -seeds $SeedNumber $SeedNumber $SeedNumber > $MsselFile
# done
