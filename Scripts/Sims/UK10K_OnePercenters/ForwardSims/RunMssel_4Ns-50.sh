...
MsselOutNoRec="../../../../Results/UK10K/ForwardSims/4Ns_-50/MsselOutNoRec"$SGE_TASK_ID".txt"
...
DistancesFileOne="../../../../Results/UK10K/ForwardSims/4Ns_-50/SimDistancesPartOneMssel"${NumberOfMarkers[$i]}"_"$SGE_TASK_ID".txt"
DistancesFileTwo="../../../../Results/UK10K/ForwardSims/4Ns_-50/SimDistancesPartTwoMssel"${NumberOfMarkers[$i]}"_"$SGE_TASK_ID".txt"
DistancesFile="../../../../Results/UK10K/ForwardSims/4Ns_-50/SimDistancesMssel"${NumberOfMarkers[$i]}"_"$SGE_TASK_ID".txt"
