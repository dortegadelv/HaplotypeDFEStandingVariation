...
#$ -N ForWF
#$ -o ../../../../Results/MediumBottleneck/ForwardSims/4Ns_-50/Trash
#$ -e ../../../../Results/MediumBottleneck/ForwardSims/4Ns_-50/Trash
...
time perl ../../ConstantPopSize/ForwardSims/GetListOfRunsWhereFrequencyMatches.pl 0.01 0.01 ../../../../Results/MediumBottleneck/ForwardSims/4Ns_-50/Output.$SGE_TASK_ID.full_out.txt ../../../../Results/MediumBottleneck/ForwardSims/4Ns_-50/Alleles_$SGE_TASK_ID.txt 0 80100

File="../../../../Results/MediumBottleneck/ForwardSims/4Ns_-50/Output."$SGE_TASK_ID".full_out.txt"
