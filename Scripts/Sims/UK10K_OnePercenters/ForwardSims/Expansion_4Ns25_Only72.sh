...
ParameterFile="ParameterFile_4Ns25_"$i"_B.txt"

time perl ../../ConstantPopSize/ForwardSims/GetListOfRunsWhereFrequencyMatches.pl ${LowFreq[$i]} ${UpFreq[$i]} ../../../../Results/UK10K/ForwardSims/4Ns_25/Output.$SLURM_ARRAY_TASK_ID.full_out.txt ../../../../Results/UK10K/ForwardSims/4Ns_25/$AlleleFile 0 24834

File="../../../../Results/UK10K/ForwardSims/4Ns_25/Output."$SLURM_ARRAY_TASK_ID".full_out.txt"
