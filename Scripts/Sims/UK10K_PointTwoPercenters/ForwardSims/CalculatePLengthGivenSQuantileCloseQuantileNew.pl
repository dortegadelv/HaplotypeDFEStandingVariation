...
print "LeftMid=$QuantileRec[$QuantileLeft]\tQuantLeft=$QuantileLeft\tLeftBefore=$QuantileRec[$QuantileLeft-1]\tLeftAfter=$QuantileRec[$QuantileLeft+1]\tRightMid=$QuantileRec[$QuantileRight]\tQuantRight=$QuantileRight\tRightBefore=$QuantileRec[$QuantileRight-1]\tRightAfter=$QuantileRec[$QuantileRight+1]\tT5=$AppropriateVariantRecNumber\t";
