...
time perl ../../ConstantPopSize/ForwardSims/GetListOfRunsWhereFrequencyMatches.pl 0.01 0.01 ../../../../Results/PopExpansionCEU/ForwardSims/4Ns_-50/Output.$SLURM_ARRAY_TASK_ID.full_out.txt ../../../../Results/PopExpansionCEU/ForwardSims/4Ns_-50/Alleles_$SLURM_ARRAY_TASK_ID.txt 0 80100

File="../../../../Results/PopExpansionCEU/ForwardSims/4Ns_-50/Output."$SLURM_ARRAY_TASK_ID".full_out.txt"
