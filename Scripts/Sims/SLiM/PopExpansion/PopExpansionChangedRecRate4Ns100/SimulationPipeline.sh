...
ValueOne=$(( ( $SLURM_ARRAY_TASK_ID - 1 ) * 48 + 1 ))
ValueTwo=$(( ( $SLURM_ARRAY_TASK_ID ) * 48 ))
...
python simulate_treeseqPopExpansion.py -c$CurrentChromosome -s$StartingRegion -o$i -n60000
