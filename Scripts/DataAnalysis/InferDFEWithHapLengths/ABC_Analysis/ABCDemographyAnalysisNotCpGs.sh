...
ExitWindowDistanceFile="../../../../Results/ABCAnalysis/Output/WindowDistanceOutNotCpG"$SGE_TASK_ID".txt"
...
DistanceOut="../../../../Results/ABCAnalysis/Output/DistanceOutNotCpG"$SGE_TASK_ID".txt"
ExitWindowDistanceFile="../../../../Results/ABCAnalysis/Output/WindowDistanceOutNotCpG"$SGE_TASK_ID".txt"
ExitWindowLowRecDistanceFile="../../../../Results/ABCAnalysis/Output/WindowDistanceLowRecOut"$SGE_TASK_ID".txt"
...
../../../../Programs/Mssel/mssel3 73 152 1 72 $ReducedTrajectories 1 -t tbs -r tbs 250000 -eN tbs tbs -eN tbs tbs -eN tbs tbs -eN tbs tbs -seeds $RandomNumber $RandomNumber $RandomNumber < $RandomNumberFile > $MsselOut
...
../../../../Programs/Mssel/mssel3 73 152 1 72 $ReducedTrajectories 1 -t tbs -r tbs 250000 -eN tbs tbs -eN tbs tbs -eN tbs tbs -eN tbs tbs -seeds $RandomNumber $RandomNumber $RandomNumber < $RightRandomNumberFile > $MsselOut
