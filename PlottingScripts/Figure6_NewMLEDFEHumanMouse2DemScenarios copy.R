...
pdf("../Figures/Figure6_MLEDFEHumanMouse2DemScenarios.pdf",width=7*2,height=7*4/4)
par(mfrow = c(2,4),mar=c(5,5,5,3))
...
beanplot(-FourNsMeans,main="F) Constant Size\nMouse DFE",ylab="Mean 4Ns value",cex.lab=2,cex.main=2.5,cex.axis=2,ylim=c(-200,10),col = c("#CAB2D6", "#33A02C", "#B2DF8A"), border = "#CAB2D6", maxstripline=0.15, beanlinewd=0.5, overall=10000, what=c(FALSE,TRUE,TRUE,TRUE), overallline = "median", ll=0.5)
...
beanplot(-FourNsMeans,main="G) Population expansion\nHuman DFE",ylab="Mean 4Ns value",cex.lab=2,cex.main=2.5,cex.axis=2,ylim=c(-200,10), col = c("#CAB2D6", "#33A02C", "#B2DF8A"), border = "#CAB2D6", maxstripline=0.15, beanlinewd=0.5, overall=10000, what=c(FALSE,TRUE,TRUE,TRUE), overallline = "median", ll=0.5)
...
beanplot(-FourNsMeans,main="H) Population expansion\nMouse DFE",ylab="Mean 4Ns value",cex.lab=2,cex.main=2.5,cex.axis=2,ylim=c(-200,10), col = c("#CAB2D6", "#33A02C", "#B2DF8A"), border = "#CAB2D6", maxstripline=0.15, beanlinewd=0.5, overall=10000, what=c(FALSE,TRUE,TRUE,TRUE), overallline = "median", ll=0.5)
