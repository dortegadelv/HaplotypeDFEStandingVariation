...
DistancesFileOne="../../../../Results/UK10K/ForwardSims/4Ns_25/SimDistancesPartOneMssel"${NumberOfMarkers[$i]}"_"$Reps".txt"
DistancesFileTwo="../../../../Results/UK10K/ForwardSims/4Ns_25/SimDistancesPartTwoMssel"${NumberOfMarkers[$i]}"_"$Reps".txt"
DistancesFile="../../../../Results/UK10K/ForwardSims/4Ns_25/SimDistancesMssel"${NumberOfMarkers[$i]}"_"$Reps".txt"
