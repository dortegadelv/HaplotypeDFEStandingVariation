...
File="../../../../Results/ConstantPopSizePopFrequency/ImportanceSamplingSims/ExitMssel_0.01_0_"$FileNumber".txtTrajectory.txt"
ExitMssel="../../../../Results/ConstantPopSizePopFrequency/ImportanceSamplingSims/TrajParTrajPartMsselOut_"$FileNumber"_"$Repetition".txt"
MsselFile="../../../../Results/ConstantPopSizePopFrequency/ImportanceSamplingSims/MsselFileOut_"$FileNumber"_"$Repetition".txt"
DistancesFile="../../../../Results/ConstantPopSizePopFrequency/ImportanceSamplingSims/DistancesFile10000_"$FileNumber"_"$Repetition".txt"
