...
DistancesFileOne="../../../../Results/UK10K/ForwardSims/4Ns_50/SimDistancesPartOneMssel"${NumberOfMarkers[$i]}"_"$Reps".txt"
DistancesFileTwo="../../../../Results/UK10K/ForwardSims/4Ns_50/SimDistancesPartTwoMssel"${NumberOfMarkers[$i]}"_"$Reps".txt"
DistancesFile="../../../../Results/UK10K/ForwardSims/4Ns_50/SimDistancesMssel"${NumberOfMarkers[$i]}"_"$Reps".txt"
