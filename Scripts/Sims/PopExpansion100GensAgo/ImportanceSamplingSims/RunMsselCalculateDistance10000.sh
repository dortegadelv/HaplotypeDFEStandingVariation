...
File="../../../../Results/PopExpansion100GensAgo/ImportanceSamplingSims/ExitMssel_0.01_0_"$FileNumber".txtTrajectory.txt"
ExitMssel="../../../../Results/PopExpansion100GensAgo/ImportanceSamplingSims/TrajParTrajPartMsselOut_"$FileNumber"_"$Repetition".txt"
MsselFile="../../../../Results/PopExpansion100GensAgo/ImportanceSamplingSims/MsselFileOut_"$FileNumber"_"$Repetition".txt"
DistancesFile="../../../../Results/PopExpansion100GensAgo/ImportanceSamplingSims/DistancesFile10000_"$FileNumber"_"$Repetition".txt"
