...
time perl ../../ConstantPopSize/ForwardSims/GetListOfRunsWhereFrequencyMatches.pl 0.01 0.01 ../../../../Results/PopExpansionMousePlusPositiveLongerBurnIn/ForwardSims/MousePart/Output.$SLURM_ARRAY_TASK_ID.full_out.txt ../../../../Results/PopExpansionMousePlusPositiveLongerBurnIn/ForwardSims/MousePart/Alleles_$SLURM_ARRAY_TASK_ID.txt 0 80100

File="../../../../Results/PopExpansionMousePlusPositiveLongerBurnIn/ForwardSims/MousePart/Output."$SLURM_ARRAY_TASK_ID".full_out.txt"
