...
time perl ../../ConstantPopSize/ForwardSims/GetListOfRunsWhereFrequencyMatches.pl 0.01 0.01 ../../../../Results/ConstantPopSizeLongerBurnInMouse/ForwardSims/Output.$SLURM_ARRAY_TASK_ID.full_out.txt ../../../../Results/ConstantPopSizeLongerBurnInMouse/ForwardSims/Alleles_$SLURM_ARRAY_TASK_ID.txt 0 160000

File="../../../../Results/ConstantPopSizeLongerBurnInMouse/ForwardSims/Output."$SLURM_ARRAY_TASK_ID".full_out.txt"
