...
File="ConstantSizeDenserGrid/ExitMssel_0.01_0_"$SGE_TASK_ID".txtTrajectory.txt"
ExitMssel="ConstantSizeDenserGrid/TrajParTrajPartMsselOut_"$SGE_TASK_ID".txt"
MsselFile="MsselFiles/MsselFileOut_"$SGE_TASK_ID".txt"
DistancesFile="ConstantSizeDenserGrid/DistancesFile_"$SGE_TASK_ID".txt"
...
# for k in {1..1000}
# do
./mssel3 3 1000 1 2 $ExitMssel 1 -r 100 500000 -t 100 >> $MsselFile
# done
