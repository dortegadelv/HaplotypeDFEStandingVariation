...
../../../../Programs/Mssel/mssel3 73 100 1 72 $ExitMssel 1 -r ${RecRate[$j]} 250000 -t 7889.85 -eN 0.0 1.0 -eN 0.0001188 0.0069583 -eN 0.0006892 0.0055704 -eN 0.0015257 0.0432898 -eN 0.0044274 0.0218350 -seeds $SeedNumber $SeedNumber $SeedNumber > $MsselFile
# done
