open (FILE,"LDistributionPopExpansionSLiM4Ns100.txt") or die "NO";
@LDistData = ();
...
$ExitFile = "../../../../Results/ABCAnalysisPopExpansionLessFiveFold/Output/WindowMismatchNotCpG4Ns_100".$i.".txt";
