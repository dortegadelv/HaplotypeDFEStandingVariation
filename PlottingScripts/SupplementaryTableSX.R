...
Prob <- pgamma(1e-5*4594,Alpha,scale=Beta) - pgamma(0,Alpha,scale=Beta)
Prob
Prob <- pgamma(1e-4*4594,Alpha,scale=Beta) - pgamma(1e-5*4594,Alpha,scale=Beta)
Prob
Prob <- pgamma(1e-3*4594,Alpha,scale=Beta) - pgamma(1e-4*4594,Alpha,scale=Beta)
Prob
Prob <- 1- pgamma(1e-3*4594,Alpha,scale=Beta)
Prob
...
Prob <- (pgamma(1e-5*4594,Alpha,scale=Beta) - pgamma(0,Alpha,scale=Beta)) * (1 - 0.092) + 0.092
Prob
Prob <- (pgamma(1e-4*4594,Alpha,scale=Beta) - pgamma(1e-5*4594,Alpha,scale=Beta)) * (1 - 0.092)
Prob
Prob <- (pgamma(1e-3*4594,Alpha,scale=Beta) - pgamma(1e-4*4594,Alpha,scale=Beta)) * (1 - 0.092)
Prob
Prob <- 1- pgamma(1e-3*4594,Alpha,scale=Beta) * (1 - 0.092)
Prob
