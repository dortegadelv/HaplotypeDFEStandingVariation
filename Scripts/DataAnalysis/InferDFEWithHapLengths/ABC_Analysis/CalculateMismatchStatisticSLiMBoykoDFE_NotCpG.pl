open (FILE,"LDistributionPopExpansionSLiMBoykoDFE.txt") or die "NO";
@LDistData = ();
...
$ExitFile = "../../../../Results/ABCAnalysisPopExpansionLessFiveFold/Output/WindowMismatchNotCpGBoykoDFE".$i.".txt";
