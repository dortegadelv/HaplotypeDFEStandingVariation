...
File="../../../../Results/UK10K_OnePercenters/ImportanceSamplingSims/ExitMsselHighPop_0.01_100_"$FileNumber".txtTrajectory.txt"
ExitMssel="../../../../Results/UK10K_OnePercenters/ImportanceSamplingSims/TrajParTrajPartMsselOutHighPop_"$FileNumber"_"$Repetition".txt"
...
for j in {1..1}
do
DistancesFile="../../../../Results/UK10K_OnePercenters/ImportanceSamplingSims/Quantile"$j"/DistancesFileWithRec10000HighPop_"$FileNumber"_"$Repetition".txt"
rm $DistancesFile
...
for i in {1..1000}
do
perl ../../ConstantPopSize/ImportanceSamplingSims/TrajectoryPartMssel.pl $File $i $ExitMssel 551894
LastFrequency=$( tail -n1 $ExitMssel | awk '{print $2}' )
echo $LastFrequency

for j in {1..1}
do
MsselFile="../../../../Results/UK10K_OnePercenters/ImportanceSamplingSims/Quantile"$j"/MsselFileOutHighPop_"$FileNumber"_"$Repetition".txt"
DistancesFile="../../../../Results/UK10K_OnePercenters/ImportanceSamplingSims/Quantile"$j"/DistancesFileWithRec10000HighPop_"$FileNumber"_"$Repetition".txt"
