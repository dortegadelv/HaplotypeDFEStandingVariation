...
HapLengths=$DirToCreate"HapLengthsLessFullHap"$k".txt"
...
${Line[$i]} > $MsselOut
perl DistanceToFirstSegregatingSiteMultiSequence_NoSingletonsBothSidesFullHap.pl $MsselOut $HapLengths 1 40
# rm $MsselOut
