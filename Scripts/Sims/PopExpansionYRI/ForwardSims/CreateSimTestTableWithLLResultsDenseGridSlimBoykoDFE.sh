...
ResultsFile[4]="PopExpansionChangedRecRateBoyko"
...
rm $ResultsFile
HapFile="../../SLiM/PopExpansion/PopExpansionChangedRecRateBoykoDFE/BootstrapNS"$Repetition".txt"
Table="../../../../Results/PopExpansion"${FourNs[$i]}"/ImportanceSamplingSims/DFETableToTest.txt"
...
ResultsFile="../../../../Results/"${ResultsFile[$i]}"/ForwardSims/HapLengths/ExitFileNoRecLessSmallN"$Repetition".txt"
rm $ResultsFile
HapFile="../../SLiM/PopExpansion/PopExpansionChangedRecRateBoykoDFE/BootstrapNS"$Repetition".txt"
Table="../../../../Results/PopExpansion"${FourNs[$i]}"/ImportanceSamplingSims/DFETableToTestSmall.txt"
perl ../../ConstantPopSize/ForwardSims/CalculatePLengthGivenS.pl $HapFile 250000 $Table ../ImportanceSamplingSims/TestT2Bounds.txt $ResultsFile
