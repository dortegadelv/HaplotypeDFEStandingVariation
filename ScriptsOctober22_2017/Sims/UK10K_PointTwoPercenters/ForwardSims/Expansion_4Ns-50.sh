...
#$ -N ForWF
#$ -o ../../../../Results/UK10K/ForwardSims/4Ns_-50/Trash
#$ -e ../../../../Results/UK10K/ForwardSims/4Ns_-50/Trash
...
time perl ../../ConstantPopSize/ForwardSims/GetListOfRunsWhereFrequencyMatches.pl 0.0095 0.0105 ../../../../Results/UK10K/ForwardSims/4Ns_-50/Output.$SGE_TASK_ID.full_out.txt ../../../../Results/UK10K/ForwardSims/4Ns_-50/Alleles_$SGE_TASK_ID.txt 0 122220

File="../../../../Results/UK10K/ForwardSims/4Ns_-50/Output."$SGE_TASK_ID".full_out.txt"
