...
time perl ../../ConstantPopSize/ForwardSims/GetListOfRunsWhereFrequencyMatches.pl 0.01 0.01 ../../../../Results/ConstantPopSizeLongBurnInMouse/ForwardSims/Output.$SLURM_ARRAY_TASK_ID.full_out.txt ../../../../Results/ConstantPopSizeLongBurnInMouse/ForwardSims/Alleles_$SLURM_ARRAY_TASK_ID.txt 0 160000

File="../../../../Results/ConstantPopSizeLongBurnInMouse/ForwardSims/Output."$SLURM_ARRAY_TASK_ID".full_out.txt"
