...
#$ -N ForWF
#$ -o ../../../../Results/RecentBottleneck/ForwardSims/4Ns_-50/Trash
#$ -e ../../../../Results/RecentBottleneck/ForwardSims/4Ns_-50/Trash
...
time perl ../../ConstantPopSize/ForwardSims/GetListOfRunsWhereFrequencyMatches.pl 0.01 0.01 ../../../../Results/RecentBottleneck/ForwardSims/4Ns_-50/Output.$SGE_TASK_ID.full_out.txt ../../../../Results/RecentBottleneck/ForwardSims/4Ns_-50/Alleles_$SGE_TASK_ID.txt 0 80100

File="../../../../Results/RecentBottleneck/ForwardSims/4Ns_-50/Output."$SGE_TASK_ID".full_out.txt"
