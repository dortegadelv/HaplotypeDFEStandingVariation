...
time perl ../../../ConstantPopSize/ForwardSims/GetListOfRunsWhereFrequencyMatches.pl 0.0099 0.0101 TestData/run.3/full_out.run.3.num.$SGE_TASK_ID.N.10000.h.0.500000.F.0.000000.txt TestData/run.3/Alleles$SGE_TASK_ID.txt 0 80100

time GSL_RNG_SEED=$SGE_TASK_ID GSL_RNG_TYPE=mrg ../fwd_seldist_gsl_2012_4epoch.debug -m1000 -t$SGE_TASK_ID -z3 -gpoint 0.00025 -f1.0 -h0.5 -F0.0 -n20 -RPopulationExpansionModel.txt -S0 -TTestData/run.3/Alleles$SGE_TASK_ID.txt TestData/run.3/Traj_0.01_$SGE_TASK_ID.txt TestData/
