...
DistancesFile="/project2/jnovembre/diegoortega/HaplotypeDFEStandingVariation/Results/ConstantPopSize/ImportanceSamplingSims/DistancesFile10000_"$FileNumber"_"$Repetition".txt"
