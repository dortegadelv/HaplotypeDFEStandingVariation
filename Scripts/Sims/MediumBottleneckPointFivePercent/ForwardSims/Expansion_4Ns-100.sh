...
#$ -N ForWF
#$ -o ../../../../Results/MediumBottleneckPointFivePercent/ForwardSims/4Ns_-100/Trash
#$ -e ../../../../Results/MediumBottleneckPointFivePercent/ForwardSims/4Ns_-100/Trash
...
time perl ../../ConstantPopSize/ForwardSims/GetListOfRunsWhereFrequencyMatches.pl 0.005 0.005 ../../../../Results/MediumBottleneckPointFivePercent/ForwardSims/4Ns_-100/Output.$SGE_TASK_ID.full_out.txt ../../../../Results/MediumBottleneckPointFivePercent/ForwardSims/4Ns_-100/Alleles_$SGE_TASK_ID.txt 0 80100

File="../../../../Results/MediumBottleneckPointFivePercent/ForwardSims/4Ns_-100/Output."$SGE_TASK_ID".full_out.txt"
