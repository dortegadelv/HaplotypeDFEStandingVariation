$ExitFile = "../../../../Results/PopExpansion/ImportanceSamplingSims/SumDistancesFile10000_3Windows.txt";
...
for ( $k = 1; $k <= 1; $k++ ){
$InputFile = "../../../../Results/PopExpansion/ImportanceSamplingSims/DistancesFile10000_3Windows_".$j."_".$k.".txt";
