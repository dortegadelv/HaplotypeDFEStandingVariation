$ExitFile = "../../../../Results/PopExpansionYRI/ImportanceSamplingSims/SumDistancesFile10000.txt";
...
for ( $k = 1; $k <= 1; $k++ ){
$InputFile = "../../../../Results/PopExpansionYRI/ImportanceSamplingSims/DistancesFile10000_".$j."_".$k.".txt";
