...
pdf("../Figures/SuppFigure5_DFEStandingToNewVariationBarPlotAltConstantLongerBurnIn.pdf",width=10,height = 3.5)
...
LastAlleleNumber <- (1-pgamma(90,Alpha,scale=Beta))* ((200000)*2500*1000)
