...
HapLengths=$DirToCreate"HapLengthsDifRecRateNS"$k".txt"
...
Line[1]="../../../Programs/Mssel/mssel3 41 300 1 40 $ResampledTrajectory 250000 -r tbs 499999 -t 240 -seeds $k $k $k"
Line[2]="../../../Programs/Mssel/mssel3 41 300 1 40 $ResampledTrajectory 250000 -r tbs 499999 -t 240 -seeds $k $k $k"
# Bases = Theta /(4Nu) = 600/(4*50000*1.2e-8) = 250000
Line[3]="../../../Programs/Mssel/mssel3 41 300 1 40 $ResampledTrajectory 250000 -r tbs 499999 -t 1200 -eN 0.0 1.0 -eN 0.0005 0.1 -seeds $k $k $k"
Line[4]="../../../Programs/Mssel/mssel3 41 300 1 40 $ResampledTrajectory 250000 -r tbs 499999 -t 1200 -eN 0.0 1.0 -eN 0.0005 0.1 -seeds $k $k $k"
Line[5]="../../../Programs/Mssel/mssel3 41 300 1 40 $ResampledTrajectory 250000 -r tbs 499999 -t 1200 -eN 0.0 1.0 -eN 0.0005 0.1 -seeds $k $k $k"
Line[6]="../../../Programs/Mssel/mssel3 41 300 1 40 $ResampledTrajectory 250000 -r tbs 499999 -t 1200 -eN 0.0 1.0 -eN 0.0005 0.1 -seeds $k $k $k"

${Line[$i]} < ResampledBpRecRatePerVariantNoCpG.txt > $MsselOut
