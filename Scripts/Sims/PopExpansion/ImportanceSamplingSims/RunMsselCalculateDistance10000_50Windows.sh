...
ExitMssel="../../../../Results/PopExpansion/ImportanceSamplingSims/TrajParTrajPartMsselOut_50Windows_"$FileNumber"_"$Repetition".txt"
MsselFile="../../../../Results/PopExpansion/ImportanceSamplingSims/MsselFileOut_50Windows_"$FileNumber"_"$Repetition".txt"
DistancesFile="../../../../Results/PopExpansion/ImportanceSamplingSims/DistancesFile10000_50Windows_"$FileNumber"_"$Repetition".txt"
...
# done
# time perl ../../ConstantPopSize/ImportanceSamplingSims/DistanceToFirstSegregatingSite.pl $MsselFile $DistancesFile 250000 TestT2Bounds_50Windows.txt
