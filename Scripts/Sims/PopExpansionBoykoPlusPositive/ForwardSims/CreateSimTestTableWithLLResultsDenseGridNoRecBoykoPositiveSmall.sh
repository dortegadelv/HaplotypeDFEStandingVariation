...
ResultsFile="../../../../Results/PopExpansionBoykoPlusPositive/ForwardSims/MixBoykoPositive/HapLengths/ExitFileNoRecSmallN"$i".txt"
rm $ResultsFile

perl ../../ConstantPopSize/ForwardSims/CalculatePLengthGivenS.pl $HapFile 250000 ../../../../Results/PopExpansionBoykoPlusPositive/ImportanceSampling/DFETableToTestBoykoPositiveSmall.txt ../ImportanceSamplingSims/TestT2Bounds.txt $ResultsFile
done
