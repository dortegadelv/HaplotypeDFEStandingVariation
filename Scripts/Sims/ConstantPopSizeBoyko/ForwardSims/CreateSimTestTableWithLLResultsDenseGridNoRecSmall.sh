...
for (( i = $Start ; i <= $End ; i++ ))
do
HapFile="../../../../Results/ConstantPopSizeBoyko/ForwardSims/HapLengths/HapLengths"$i".txt"
ResultsFile="../../../../Results/ConstantPopSizeBoyko/ForwardSims/HapLengths/ExitFileNoRecSmallN"$i".txt"
rm $ResultsFile
