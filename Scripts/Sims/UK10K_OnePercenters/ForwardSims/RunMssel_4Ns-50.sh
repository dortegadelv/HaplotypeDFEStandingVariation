...
# TrajNum=$( wc -l ../../../../Results/UK10K/ForwardSims/4Ns_-50/Alleles{1..1000}.txt | tail -n1 | awk '{print $1}' )
# echo $TrajNum
...
ResampledTrajFile="../../../../Results/UK10K/ForwardSims/4Ns_-50/ResampledTraj"$SLURM_ARRAY_TASK_ID".txt"
MsselOut="../../../../Results/UK10K/ForwardSims/4Ns_-50/MsselOut"$SLURM_ARRAY_TASK_ID".txt"
HapLengths="../../../../Results/UK10K/ForwardSims/4Ns_-50/HapLength"$SLURM_ARRAY_TASK_ID".txt"
MsselOutNoRec="../../../../Results/UK10K/ForwardSims/4Ns_-50/MsselOutNoRec"$SLURM_ARRAY_TASK_ID".txt"
HapLengthsNoRec="../../../../Results/UK10K/ForwardSims/4Ns_-50/HapLengthNoRec"$SLURM_ARRAY_TASK_ID".txt"
MsselOutNoRecAnc="../../../../Results/UK10KForwardSims/4Ns_-50/MsselOutNoRecAnc"$SLURM_ARRAY_TASK_ID".txt"
HapLengthsNoRecAnc="../../../../Results/UK10K/ForwardSims/4Ns_-50/HapLengthNoRecAnc"$SLURM_ARRAY_TASK_ID".txt"

MsselOutMultiSeq="../../../../Results/UK10K/ForwardSims/4Ns_-50/MsselOutMultiSeq"$SLURM_ARRAY_TASK_ID".txt"
HapLengthsMultiSeq="../../../../Results/UK10K/ForwardSims/4Ns_-50/HapLengthMultiSeq"$SLURM_ARRAY_TASK_ID".txt"
T2File="../../../../Results/UK10K/ForwardSims/4Ns_-50/T2Values"$SLURM_ARRAY_TASK_ID".txt"
...
# cat ../../../../Results/UK10K/ForwardSims/4Ns_-50/TrajMsselLike.txt | ../stepftn > ../../../../Results/UK10K/ForwardSims/4Ns_-50/ReducedTrajectories10000.txt
...
HapLengths="../../../../Results/UK10K/ForwardSims/4Ns_-50/HapLengthN"${NumberOfMarkers[$i]}"_"$Reps".txt"
HapLengthsNoRec="../../../../Results/UK10K/ForwardSims/4Ns_-50/HapLengthNoRecN"${NumberOfMarkers[$i]}"_"$Reps".txt"
HapLengthsMultiSeq="../../../../Results/UK10K/ForwardSims/4Ns_-50/HapLengthMultiSeqN"${NumberOfMarkers[$i]}"_"$Reps".txt"
HapLengthsNoRecAnc="../../../../Results/UK10K/ForwardSims/4Ns_-50/HapLengthNoRecAncN"${NumberOfMarkers[$i]}"_"$Reps".txt"
HapLengthsRecAware="../../../../Results/UK10K/ForwardSims/4Ns_-50/HapLengthRecAwareN"${NumberOfMarkers[$i]}"_"$Reps".txt"
DistancesFileOne="../../../../Results/UK10K/ForwardSims/4Ns_-50/SimDistancesPartOneMssel"${NumberOfMarkers[$i]}"_"$Reps".txt"
DistancesFileTwo="../../../../Results/UK10K/ForwardSims/4Ns_-50/SimDistancesPartTwoMssel"${NumberOfMarkers[$i]}"_"$Reps".txt"
DistancesFile="../../../../Results/UK10K/ForwardSims/4Ns_-50/SimDistancesMssel"${NumberOfMarkers[$i]}"_"$Reps".txt"
SamplesFile="../../../../Results/UK10K/ForwardSims/4Ns_-50/SamplesToCheckMssel"${NumberOfMarkers[$i]}"_"$Reps".txt"
...
for ChrNum in {69..76}
do
Value[$ChrNum]=$( grep 'age' ../../../../Results/UK10K/ForwardSims/4Ns_-50/ReducedTrajectories_$ChrNum.txt | wc -l )
done
...
perl ../../ConstantPopSize/ForwardSims/SampleTrajectories.pl ../../../../Results/UK10K/ForwardSims/4Ns_-50/ReducedTrajectories_$ChrNum.txt 1 $ResampledTrajFile $RandomSeed
