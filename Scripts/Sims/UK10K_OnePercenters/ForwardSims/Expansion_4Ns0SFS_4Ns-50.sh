...
for i in {69..76}
do
time perl ../../ConstantPopSize/ForwardSims/GetListOfRunsWhereFrequencyMatches.pl ${LowFreq[$i]} ${UpFreq[$i]} ../../../../Results/UK10K/ForwardSims/4Ns_-50/Output.$SLURM_ARRAY_TASK_ID.full_out.txt ../../../../Results/UK10K/ForwardSims/4Ns_-50/Alleles_$SLURM_ARRAY_TASK_ID.$i.txt 0 24834

UpperLowFreq=`echo 1.0 - ${LowFreq[$i]} | bc`
UpperUpFreq=`echo 1.0 - ${UpFreq[$i]} | bc` 

time perl ../../ConstantPopSize/ForwardSims/GetListOfRunsWhereFrequencyMatches.pl $UpperUpFreq $UpperLowFreq ../../../../Results/UK10K/ForwardSims/4Ns_-50/Output.$SLURM_ARRAY_TASK_ID.full_out.txt ../../../../Results/UK10K/ForwardSims/4Ns_-50/Alleles99Percent_$SLURM_ARRAY_TASK_ID.$i.txt 0 24834
