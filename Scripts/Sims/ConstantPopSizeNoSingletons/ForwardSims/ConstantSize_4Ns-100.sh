...
#$ -cwd
#$ -N ForWF
#$ -o ../../../../Results/ConstantPopSize/ForwardSims/4Ns_-100/Trash
#$ -e ../../../../Results/ConstantPopSize/ForwardSims/4Ns_-100/Trash
...
time perl GetListOfRunsWhereFrequencyMatches.pl 0.01 0.01 ../../../../Results/ConstantPopSize/ForwardSims/4Ns_-100/Output.$SGE_TASK_ID.full_out.txt ../../../../Results/ConstantPopSize/ForwardSims/4Ns_-100/Alleles_$SGE_TASK_ID.txt 0 160000

File="../../../../Results/ConstantPopSize/ForwardSims/4Ns_-100/Output."$SGE_TASK_ID".full_out.txt"
