$ExitFile = "../../../../Results/ConstantPopSize/ImportanceSamplingSims/SumDistancesFile10000_50Windows.txt";
...
for ( $k = 1; $k <= 1; $k++ ){
$InputFile = "../../../../Results/ConstantPopSize/ImportanceSamplingSims/DistancesFile10000_50Windows_".$j."_".$k.".txt";
