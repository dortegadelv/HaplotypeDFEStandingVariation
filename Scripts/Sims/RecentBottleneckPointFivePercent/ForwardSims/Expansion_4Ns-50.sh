...
#$ -N ForWF
#$ -o ../../../../Results/RecentBottleneckPointFivePercent/ForwardSims/4Ns_-50/Trash
#$ -e ../../../../Results/RecentBottleneckPointFivePercent/ForwardSims/4Ns_-50/Trash
...
time perl ../../ConstantPopSize/ForwardSims/GetListOfRunsWhereFrequencyMatches.pl 0.005 0.005 ../../../../Results/RecentBottleneckPointFivePercent/ForwardSims/4Ns_-50/Output.$SGE_TASK_ID.full_out.txt ../../../../Results/RecentBottleneckPointFivePercent/ForwardSims/4Ns_-50/Alleles_$SGE_TASK_ID.txt 0 80100

File="../../../../Results/RecentBottleneckPointFivePercent/ForwardSims/4Ns_-50/Output."$SGE_TASK_ID".full_out.txt"
