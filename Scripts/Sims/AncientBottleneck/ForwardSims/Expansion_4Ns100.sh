...
time perl ../../ConstantPopSize/ForwardSims/GetListOfRunsWhereFrequencyMatches.pl 0.01 0.01 ../../../../Results/AncientBottleneck/ForwardSims/4Ns_100/Output.$SLURM_ARRAY_TASK_ID.full_out.txt ../../../../Results/AncientBottleneck/ForwardSims/4Ns_100/Alleles_$SLURM_ARRAY_TASK_ID.txt 0 80100

File="../../../../Results/AncientBottleneck/ForwardSims/4Ns_100/Output."$SLURM_ARRAY_TASK_ID".full_out.txt"
...
# time perl ../../../ConstantPopSize/ForwardSims/GetListOfRunsWhereFrequencyMatches.pl 0.0099 0.0101 TestData/run.8/full_out.run.8.num.$SLURM_ARRAY_TASK_ID.N.10000.h.0.500000.F.0.000000.txt TestData/run.8/Alleles$SLURM_ARRAY_TASK_ID.txt 0 80100
