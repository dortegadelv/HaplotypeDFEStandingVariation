...
time GSL_RNG_SEED=$SGE_TASK_ID GSL_RNG_TYPE=mrg ../../../../Programs/PReFeRSim/fwd_seldist_gsl_2012_4epoch.debug ParameterFile_4Ns100_99PercentFreqAllele.txt $SGE_TASK_ID

time perl GetListOfRunsWhereFrequencyMatches.pl 0.99 0.99 ../../../../Results/ConstantPopSize/ForwardSims/4Ns_100/Output.$SGE_TASK_ID.full_out.txt ../../../../Results/ConstantPopSize/ForwardSims/4Ns_100/Alleles_$SGE_TASK_ID.txt 0 160000
...
time GSL_RNG_SEED=$SGE_TASK_ID GSL_RNG_TYPE=mrg ../../../../Programs/PReFeRSim/fwd_seldist_gsl_2012_4epoch.debug ParameterFile_4Ns100_B99PercentFreqAllele.txt $SGE_TASK_ID
