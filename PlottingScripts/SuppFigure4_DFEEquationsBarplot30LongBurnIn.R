...
pdf("../Figures/SuppFigure4_DFEStandingToNewVariationBarPlotAltLongBurnIn.pdf",width=10,height = 3.5)
...
LastAlleleNumber <- (1-pgamma(90,Alpha,scale=Beta))* ((100000 + (100000/10000)*100)*2500*1000)
