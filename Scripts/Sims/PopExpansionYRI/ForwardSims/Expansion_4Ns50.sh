...
time perl ../../ConstantPopSize/ForwardSims/GetListOfRunsWhereFrequencyMatches.pl 0.01 0.01 ../../../../Results/PopExpansionYRI/ForwardSims/4Ns_50/Output.$SLURM_ARRAY_TASK_ID.full_out.txt ../../../../Results/PopExpansionYRI/ForwardSims/4Ns_50/Alleles_$SLURM_ARRAY_TASK_ID.txt 0 80100

File="../../../../Results/PopExpansionYRI/ForwardSims/4Ns_50/Output."$SLURM_ARRAY_TASK_ID".full_out.txt"
