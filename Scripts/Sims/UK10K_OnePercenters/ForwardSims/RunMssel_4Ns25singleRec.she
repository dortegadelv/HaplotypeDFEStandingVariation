...
TrajNum=$( wc -l ../../../../Results/UK10K/ForwardSims/4Ns_0/Alleles{1..120}.txt | tail -n1 | awk '{print $1}' )
echo $TrajNum
...
MsselOutNoRec="../../../../Results/UK10K/ForwardSims/4Ns_0/MsselOutNoRecSingleRec"$SGE_TASK_ID".txt"
HapLengthsNoRec="../../../../Results/UK10K/ForwardSims/4Ns_0/HapLengthNoRec"$SGE_TASK_ID".txt"
MsselOutNoRecAnc="../../../../Results/UK10K/ForwardSims/4Ns_0/MsselOutNoRecAnc"$SGE_TASK_ID".txt"
...
# cat ../../../../Results/UK10K/ForwardSims/4Ns_0/TrajMsselLike.txt | ../stepftn > ../../../../Results/UK10K/ForwardSims/4Ns_0/ReducedTrajectories.txt
...
DistancesFileOne="../../../../Results/UK10K/ForwardSims/4Ns_0/SimDistancesPartOneMsselSingleRec"${NumberOfMarkers[$i]}"_"$SGE_TASK_ID".txt"
DistancesFileTwo="../../../../Results/UK10K/ForwardSims/4Ns_0/SimDistancesPartTwoMsselSingleRec"${NumberOfMarkers[$i]}"_"$SGE_TASK_ID".txt"
DistancesFile="../../../../Results/UK10K/ForwardSims/4Ns_0/SimDistancesMsselSingleRec"${NumberOfMarkers[$i]}"_"$SGE_TASK_ID".txt"


perl ../../ConstantPopSize/ForwardSims/SampleTrajectories.pl ../../../../Results/UK10K/ForwardSims/4Ns_0/ReducedTrajectories.txt 611 $ResampledTrajFile $SGE_TASK_ID
