...
# TrajNum=$( wc -l ../../../../Results/UK10K/ForwardSims/DFETestHighPop/Alleles{1..1000}.txt | tail -n1 | awk '{print $1}' )
# echo $TrajNum
...
MsselOutNoRecAnc="../../../../Results/UK10KForwardSims/DFETestHighPop/MsselOutNoRecAnc"$SLURM_ARRAY_TASK_ID".txt"
...
# perl TrajToMsselFormat.pl ../../../../Results/UK10K/ForwardSims/DFETestHighPop/Traj_0.01_ 20000 ../../../../Results/UK10K/ForwardSims/DFETestHighPop/TrajMsselLike.txt $TrajNum 0 1000
# cat ../../../../Results/UK10K/ForwardSims/DFETestHighPop/TrajMsselLike.txt | ../stepftn > ../../../../Results/UK10K/ForwardSims/DFETestHighPop/ReducedTrajectories10000.txt
...
HapLengths="../../../../Results/UK10K/ForwardSims/DFETestHighPop/HapLengthN"${NumberOfMarkers[$i]}"_"$Reps".txt"
HapLengthsNoRec="../../../../Results/UK10K/ForwardSims/DFETestHighPop/HapLengthNoRecN"${NumberOfMarkers[$i]}"_"$Reps".txt"
HapLengthsMultiSeq="../../../../Results/UK10K/ForwardSims/DFETestHighPop/HapLengthMultiSeqN"${NumberOfMarkers[$i]}"_"$Reps".txt"
HapLengthsNoRecAnc="../../../../Results/UK10K/ForwardSims/DFETestHighPop/HapLengthNoRecAncN"${NumberOfMarkers[$i]}"_"$Reps".txt"
HapLengthsRecAware="../../../../Results/UK10K/ForwardSims/DFETestHighPop/HapLengthRecAwareN"${NumberOfMarkers[$i]}"_"$Reps".txt"
DistancesFileOne="../../../../Results/UK10K/ForwardSims/DFETestHighPop/SimDistancesPartOneMssel"${NumberOfMarkers[$i]}"_"$Reps".txt"
DistancesFileTwo="../../../../Results/UK10K/ForwardSims/DFETestHighPop/SimDistancesPartTwoMssel"${NumberOfMarkers[$i]}"_"$Reps".txt"
DistancesFile="../../../../Results/UK10K/ForwardSims/DFETestHighPop/SimDistancesMssel"${NumberOfMarkers[$i]}"_"$Reps".txt"
SamplesFile="../../../../Results/UK10K/ForwardSims/DFETestHighPop/SamplesToCheckMssel"${NumberOfMarkers[$i]}"_"$Reps".txt"
...
for ChrNum in {69..76}
do
Value[$ChrNum]=$( grep 'age' ../../../../Results/UK10K/ForwardSims/DFETestHighPop/ReducedTrajectories_$ChrNum.txt | wc -l )
done
...
perl ../../ConstantPopSize/ForwardSims/SampleTrajectories.pl ../../../../Results/UK10K/ForwardSims/DFETestHighPop/ReducedTrajectories_$ChrNum.txt 1 $ResampledTrajFile $RandomSeed
...
../../../../Programs/Mssel/mssel3 $Num 1 1 $ChrNum $ResampledTrajFile 1 -r $LeftRec 250000 -t 6167.325 -eN 0.0 1.0 -eN 0.0001478 0.0077453 -eN 0.0008817 0.0071214 -eN 0.0019518 0.0553854 -eN 0.0056633 0.0279335 -seeds $RandomSeed $Num $Num < RecRateMissenseOnePercentLeftNoCpG.txt > $MsselOutNoRec
...
../../../../Programs/Mssel/mssel3 $Num 1 1 $ChrNum $ResampledTrajFile 1 -r $RightRec 250000 -t 6167.325 -eN 0.0 1.0 -eN 0.0001478 0.0077453 -eN 0.0008817 0.0071214 -eN 0.0019518 0.0553854 -eN 0.0056633 0.0279335 -seeds $RandomSeed $Num $RandomSeed < RecRateMissenseOnePercentRightNoCpG.txt > $MsselOutNoRec
