...
time perl ../../ConstantPopSize/ForwardSims/GetListOfRunsWhereFrequencyMatches.pl 0.01 0.01 ../../../../Results/PopExpansion1000GensAgo/ForwardSims/4Ns_50/Output.$SLURM_ARRAY_TASK_ID.full_out.txt ../../../../Results/PopExpansion1000GensAgo/ForwardSims/4Ns_50/Alleles_$SLURM_ARRAY_TASK_ID.txt 0 80100

File="../../../../Results/PopExpansion1000GensAgo/ForwardSims/4Ns_50/Output."$SLURM_ARRAY_TASK_ID".full_out.txt"
