$ExitFile = "../../../../Results/ConstantPopSize/ImportanceSamplingSims/SumDistancesFile10000_3Windows.txt";
...
for ( $k = 1; $k <= 1; $k++ ){
$InputFile = "../../../../Results/ConstantPopSize/ImportanceSamplingSims/DistancesFile10000_3Windows_".$j."_".$k.".txt";
