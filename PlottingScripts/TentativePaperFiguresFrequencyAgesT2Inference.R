...
for (j in 1:11){
	...
	MaxFreq <- 0
	for (i in 1:5){
		TrajectoryFile <- paste("FrequencyTrajectories/OutMeanTraj",DemScenario[j],Selection[i],".txt",sep="")
	...
	MaxAge <- 0
	TrajectoryFile <- paste("AlleleAges/Ages",DemScenario[j],"_",SelectionTest[1],".txt",sep="")
	Data <- read.table(TrajectoryFile)
	Max <- max(density(Data$V1*Ne[j]*2,from=0,to=quantile(Data$V1*Ne[j]*2,0.99))$x)
	for (i in 1:5){
		TrajectoryFile <- paste("AlleleAges/Ages",DemScenario[j],"_",SelectionTest[i],".txt",sep="")
		Data <- read.table(TrajectoryFile)
	...
	MaxT2 <- 0
	for (i in 1:5){
		TrajectoryFile <- paste("TTwos/",DemScenario[j],"_",SelectionTest[i],".txt",sep="")
		Data <- read.table(TrajectoryFile)
...
Plot <- paste("PotentialPaperFigures/",DemScenario[j],".pdf",sep="")
pdf(Plot,width=28/2,height=7/1.55)
par(mfrow=c(1,4))
par(mar=c(5,5,5,2) + 0.1)

	
	TrajectoryFile <- paste("FrequencyTrajectories/OutMeanTraj",DemScenario[j],Selection[1],".txt",sep="")
	Data <- read.table(TrajectoryFile)
...
#lines(Data$V1[10000:1],ISData$V2[1:10000],lwd=10,col=rgb(Color[1,1],Color[2,1],Color[3,1],100,maxColorValue=255))
	...
	TrajectoryFile <- paste("FrequencyTrajectories/OutMeanTraj",DemScenario[j],Selection[2],".txt",sep="")
	Data <- read.table(TrajectoryFile)
...
#lines(Data$V1[10000:1],ISData$V3[1:10000],lwd=10,col=rgb(Color[1,1],Color[2,1],Color[3,1],100,maxColorValue=255))
	...
	TrajectoryFile <- paste("FrequencyTrajectories/OutMeanTraj",DemScenario[j],Selection[3],".txt",sep="")
	Data <- read.table(TrajectoryFile)
...
#lines(Data$V1[10000:1],ISData$V4[1:10000],lwd=10,col=rgb(Color[1,1],Color[2,1],Color[3,1],100,maxColorValue=255))
	...
	TrajectoryFile <- paste("FrequencyTrajectories/OutMeanTraj",DemScenario[j],Selection[4],".txt",sep="")
	Data <- read.table(TrajectoryFile)
...
#lines(Data$V1[5000:1],Data$V4[1:5000],lty=3,col="red")
	...
	TrajectoryFile <- paste("FrequencyTrajectories/OutMeanTraj",DemScenario[j],Selection[5],".txt",sep="")
	Data <- read.table(TrajectoryFile)
...
#legend("topleft",c("0","-50","-100","50","100"),pch=19,col=c("black","purple","orange","red","dodgerblue"),cex=1.5,title="4Ns",bty="n")
	...
	AgesFile <- paste("AlleleAges/Ages",DemScenario[j],"_",SelectionTest[1],".txt",sep="")
...
#		abline(v=max(density(Data$V1*Ne[j]*2,from=0,to=Max)$x)-300,lty=3,lwd=3)
	...
	AgesFile <- paste("AlleleAges/Ages",DemScenario[j],"_",SelectionTest[2],".txt",sep="")
	Data <- read.table(AgesFile)
...
#	abline(v=mean(Max - Data$V1*Ne[j]*2),lwd=6,col=ColorViridisAlpha[2])
	...
	AgesFile <- paste("AlleleAges/Ages",DemScenario[j],"_",SelectionTest[3],".txt",sep="")
	Data <- read.table(AgesFile)
...
#abline(v=mean(Max - Data$V1*Ne[j]*2),lwd=6,col=ColorViridisAlpha[1])
	...
	AgesFile <- paste("AlleleAges/Ages",DemScenario[j],"_",SelectionTest[4],".txt",sep="")
	Data <- read.table(AgesFile)
...
#	StartingYValue <- length(density(Data$V1*Ne[j]*2,from=0,to=Max)$x) - Check
	...
	AgesFile <- paste("AlleleAges/Ages",DemScenario[j],"_",SelectionTest[5],".txt",sep="")
	Data <- read.table(AgesFile)
	Breaks <- seq(from=0,to=max(Data$V1*Ne[j]*2+50),by=50)
	Histogram <- hist(Data$V1*2*Ne[j],breaks=Breaks,plot=FALSE)
...
#	rect(max(density(Data$V1*Ne[j]*2,from=0,to=Max)$x)-XLimFigureTwo[j]+10,-0.02*ListMaxAge[j],max(density(Data$V1*Ne[j]*2,from=0,to=Max)$x)-XLimFigureTwo[j]+0.2*(XLimFigureTwo[j]),ListMaxAge[j],col="white",border=NA)
	AgesFile <- paste("TTwos/",DemScenario[j],"_",SelectionTest[1],".txt",sep="")
...
#		abline(v=Data$V1[XLimFigureThree[j]]-300,lty=3,lwd=3)
	...
	AgesFile <- paste("TTwos/",DemScenario[j],"_",SelectionTest[2],".txt",sep="")
	Data <- read.table(AgesFile)
	...
	AgesFile <- paste("TTwos/",DemScenario[j],"_",SelectionTest[3],".txt",sep="")
	Data <- read.table(AgesFile)
	...
	AgesFile <- paste("TTwos/",DemScenario[j],"_",SelectionTest[4],".txt",sep="")
	Data <- read.table(AgesFile)
	...
	AgesFile <- paste("TTwos/",DemScenario[j],"_",SelectionTest[5],".txt",sep="")
	Data <- read.table(AgesFile)
...
for (j in 1:11){
	...
	Plot <- paste("PotentialPaperFigures/ThreePanels",DemScenario[j],".pdf",sep="")
    if (j==7){
...
############### Population scenarios
	...
	plot(c(100000,100000-100,100000-1000),c(50000,5000,5000),type="s",xlim=c(100000-300,100000),ylim=c(0,50000),ylab="Effective Population Size",xlab="Time before the present",main="A) Population Expansion \nModel",xaxt='n',yaxt='n',cex.main=2.5,cex.lab=2.5,col="red",lwd=6)
		
	axis(1,at=c(100000,100000-100,100000-200,100000-300),labels = c("Present","100","200","300"),cex.axis=2.5)
...
############## Trajectories
	...
	Color <- col2rgb("black")
	if (j==7 || j==8){
		plot(Data$V1[5000:1],Data$V2[1:5000],xlab="Time before the present",ylab="Mean Allele Frequency",type="l",xlim=c(XLimFigureOne[j],5000),ylim=c(0,ListMaxFreq[j]*1.3),main="B) Average Frequency\nTrajectory",xaxt="n",cex.lab=2.5,cex.main=2.5,cex.axis=2.5,lwd=6,col=ColorViridis[3])
		
	}else{
		plot(Data$V1[5000:1],Data$V2[1:5000],xlab="Time before the present",ylab="Mean Allele Frequency",type="l",xlim=c(XLimFigureOne[j],5000),ylim=c(0,ListMaxFreq[j]),main="B) Average Frequency Trajectory",xaxt="n",cex.lab=2.5,cex.main=2.5,cex.axis=2.5,lwd=6,col=ColorViridis[3])
	}
#lines(Data$V1[5000:1],Data$V3[1:5000],lty=3)
#lines(Data$V1[5000:1],Data$V4[1:5000],lty=3)
#lines(Data$V1[10000:1],ISData$V2[1:10000],lwd=10,col=rgb(Color[1,1],Color[2,1],Color[3,1],100,maxColorValue=255))
...
#lines(Data$V1[5000:1],Data$V4[1:5000],lty=3,col="dodgerblue")
	...
	legend(5000-1500,0.0078,c("-100","-50","0","50","100"), lty=c(1,1,1,6,6),lwd=6,col=ColorViridis,cex=2,title=expression(paste(4,N[0],'s',sep="")),bty="n")
		...
		legend("topleft",c("-100","-50","0","50","100"), lty=c(1,1,1,6,6),lwd=6,col=ColorViridis,cex=1.8,title=expression(paste(4,N[0],'s',sep="")),bty="n")
	}else if (j == 3 ||j == 4 ||j == 11){
		legend("center",c("-100","-50","0","50","100"), lty=c(1,1,1,6,6),lwd=6,col=ColorViridis,cex=2,title=expression(paste(4,N,'s',sep="")),bty="n")
	}
#legend("topleft",c("0","-50","-100","50","100"),pch=19,col=c("black","purple","orange","red","dodgerblue"),cex=1.5,title="4Ns",bty="n")
	axis(1,at=c(5000,4000,3000,2000,1000,0),labels=c("Present","1000","2000","3000","4000","5000"),cex.lab=2,cex.axis=2.5)
	...
	if (j==7){
		...
		Length <- length(XSubset) - 1
		MaxLength <- length(density(Data$V1*Ne[j]*2,from=0,to=Max)$x)
		plot(rev(c(max(density(Data$V1*Ne[j]*2,from=0,to=Max)$x)-XLimFigureTwo[j] + 0.22*(XLimFigureTwo[j]),density(Data$V1*Ne[j]*2,from=0,to=Max)$x[(MaxLength-Length):(MaxLength)])),density(Data$V1*Ne[j]*2,from=0,to=Max)$y[1:(Length+2)],xlab="Allele Age",ylab="Probability",type="l",ylim=c(-0.2*ListMaxAge[j],ListMaxAge[j]),main="C) Allele Age",xaxt="n",yaxt="n",col=ColorViridis[3],cex.lab=2.5,cex.main=2.5,cex.axis=2.5,lwd=6,xlim=c(max(density(Data$V1*Ne[j]*2,from=0,to=Max)$x)-XLimFigureTwo[j],max(density(Data$V1*Ne[j]*2,from=0,to=Max)$x)))
		SD <- sd(Data$V1*Ne[j]*2)
		arrows(max(density(Data$V1*Ne[j]*2,from=0,to=Max)$x)-XLimFigureTwo[j]+0.1*XLimFigureTwo[j],-0.12*ListMaxAge[j],min(Max- mean(Data$V1*Ne[j]*2)+SD,Max),-0.12*ListMaxAge[j], length=0.05, angle=90, code=3,col=ColorViridis[3],lwd=6)
...
#		abline(v=mean(Max - Data$V1*Ne[j]*2),lwd=6,col=ColorViridisAlpha[3])
		points(Max - mean(Data$V1*Ne[j]*2),-0.12*ListMaxAge[j],pch=20,col=ColorViridis[3],cex=3)
#		plot(max(Data$V1*Ne[j]*2) - 0:99*50,Histogram$counts[1:100]/sum(Histogram$counts),xlab="Allele Age",ylab="Probability",type="l",ylim=c(0,YLimFigureTwo[j]),main="B) Allele Age",xaxt="n",cex.lab=2,cex.main=2,cex.axis=1.5,lwd=6,xlim=c(max(density(Data$V1*Ne[j]*2,from=0)$x)-XLimFigureTwo[j],max(Data$V1*Ne[j]*2)))
		axis(2,at=c(0,0.002,0.004,0.006,0.008,0.01,0.012,0.014,0.016,0.018,0.02),labels=c("0","0.002","0.004","0.006","0.008","0.01","0.012","0.014","0.016","0.018","0.02"),cex.lab=2,cex.axis=2.5)
## X values 
		XFirstValue <- max(density(Data$V1*Ne[j]*2,from=0,to=Max)$x) - 0.8*XLimFigureTwo[j]
		Threshold <- mean(Data$V1*Ne[j]*2) + SD-0.1*XLimFigureTwo[j]
		SubsetXValues <- subset(density(Data$V1*Ne[j]*2,from=0,to=Max)$x,density(Data$V1*Ne[j]*2,from=0,to=Max)$x > Threshold)
...
#	XLimFigureTwo[11]=3000
	if (XLimFigureTwo[j] <= 1000){
		axis(1,at=c(max(density(Data$V1*Ne[j]*2,from=0,to=Max)$x)-XLimFigureTwo[j] + 0.1*(XLimFigureTwo[j]),Max-500,Max-250,Max),labels=c(ValueToPrintXAxis,"500","250","Present"),cex.lab=2,cex.axis=2.5)
	}else if (XLimFigureTwo[j] <= 1500){
		axis(1,at=c(max(density(Data$V1*Ne[j]*2,from=0,to=Max)$x)-XLimFigureTwo[j] + 0.1*(XLimFigureTwo[j]),Max-1000,Max-500,Max),labels=c(ValueToPrintXAxis,"1000","500","Present"),cex.lab=2,cex.axis=2.5)
	}else if (XLimFigureTwo[j] <= 1750){
		axis(1,at=c(max(density(Data$V1*Ne[j]*2,from=0,to=Max)$x)-XLimFigureTwo[j] + 0.1*(XLimFigureTwo[j]),Max-2000,Max-1000,Max),labels=c(ValueToPrintXAxis,"2000","1000","Present"),cex.lab=2,cex.axis=2.5)
	}else if (XLimFigureTwo[j] <= 2000){
		axis(1,at=c(max(density(Data$V1*Ne[j]*2,from=0,to=Max)$x)-XLimFigureTwo[j] + 0.1*(XLimFigureTwo[j]),Max-1500,Max-1000,Max-500,Max),labels=c(ValueToPrintXAxis,"1500","1000","500","Present"),cex.lab=2,cex.axis=2.5)
	}else if (XLimFigureTwo[j] <= 3000){
		axis(1,at=c(max(density(Data$V1*Ne[j]*2,from=0,to=Max)$x)-XLimFigureTwo[j] + 0.1*(XLimFigureTwo[j]),Max-2000,Max-1500,Max-1000,Max-500,Max),labels=c(ValueToPrintXAxis,"2000","1500","1000","500","Present"),cex.lab=2,cex.axis=2.5)
	}
#	axis(1,at=c(Max-2500,Max-2000,Max-1500,Max-1000,Max-500,Max),labels=c("2500","2000","1500","1000","500","Present"),cex.lab=2,cex.axis=2)
#	rect(max(density(Data$V1*Ne[j]*2,from=0,to=Max)$x)-XLimFigureTwo[j]+10,-0.02*ListMaxAge[j],max(density(Data$V1*Ne[j]*2,from=0,to=Max)$x)-XLimFigureTwo[j]+0.2*(XLimFigureTwo[j]),ListMaxAge[j],col="white",border=NA)
	AgesFile <- paste("TTwos/",DemScenario[j],"_",SelectionTest[1],".txt",sep="")
	...
	plot(Data$V1[XLimFigureThree[j]:1],Data$V3[1:XLimFigureThree[j]],xlab=expression(bold(T[2])),ylab="Probability",type="l",main=expression(bold(paste("D) ",T[2],sep=""))),ylim=c(-0.2*ListMaxT2[j],1.05*ListMaxT2[j]),xaxt="n",yaxt="n",cex.lab=2.5,cex.main=2.5,cex.axis=2.5,lwd=6,col=ColorViridis[3])
#,ylim=c(0,1.0)
	if (j==7 || j==8){
#		abline(v=Data$V1[XLimFigureThree[j]]-100,lty=3,lwd=3)
		segments(Data$V1[XLimFigureThree[j]]-100,0,Data$V1[XLimFigureThree[j]]-100,100,lty=3,lwd=3)
...
#		abline(v=Data$V1[XLimFigureThree[j]]-300,lty=3,lwd=3)
	...
	points(XLimFigureThree[j]- sum(Data$V1*Data$V3),-0.2*ListMaxT2[j],pch=20,col=ColorViridis[5],cex=3)
#legend("topleft",c("0","-50","-100","50","100"),pch=19,col=c("black","purple","orange","red","dodgerblue"),cex=1.5,title="4Ns",bty="n")
	axis(1,at=c(XLimFigureThree[j]-1400,XLimFigureThree[j]-1200,XLimFigureThree[j]-1000,XLimFigureThree[j]-800,XLimFigureThree[j]-600,XLimFigureThree[j]-400,XLimFigureThree[j]-200,XLimFigureThree[j]),labels=c("1400","1200","1000","800","600","400","200","Present"),cex.lab=2,cex.axis=2.5)
	axis(2,at=c(0,0.005,0.01,0.015,0.02,0.025,0.03,0.035,0.04),labels=c("0","0.005","0.01","0.015","0.02","0.025","0.03","0.035","0.04"),cex.lab=2,cex.axis=2.5)
