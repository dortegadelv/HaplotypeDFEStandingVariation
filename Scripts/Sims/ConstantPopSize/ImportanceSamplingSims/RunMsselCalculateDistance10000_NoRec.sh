...
ExitMssel="../../../../Results/ConstantPopSize/ImportanceSamplingSims/TrajParTrajPartMsselOut_NoRec_"$FileNumber"_"$Repetition".txt"
MsselFile="../../../../Results/ConstantPopSize/ImportanceSamplingSims/MsselFileOut_NoRec_"$FileNumber"_"$Repetition".txt"
DistancesFile="../../../../Results/ConstantPopSize/ImportanceSamplingSims/DistancesFile10000_NoRec_"$FileNumber"_"$Repetition".txt"
...
# for k in {1..1000}
# do
../../../../Programs/Mssel/mssel3 41 100 1 40 $ExitMssel 1 -r 0 250000 -t 120 -seeds $SeedNumber $SeedNumber $SeedNumber > $MsselFile
# done
