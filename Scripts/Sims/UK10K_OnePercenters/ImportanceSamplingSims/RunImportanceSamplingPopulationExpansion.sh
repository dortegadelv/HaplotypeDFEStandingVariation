...
SelectionCoef1=$( echo "scale=10;$SelectionS / 4594" | bc )
...
time ../../../../Programs/ISProgram/FoIS -A $SelectionCoef2 -a $SelectionCoef1 -f 0.01 -r 1000 -N 226252 -s $Seed -F ../../../../Results/UK10K_OnePercenters/ImportanceSamplingSims/$File -b ../../ConstantPopSize/ImportanceSamplingSims/Bounds.txt -D DemHistExpansion.txt -X NewSelectionValues.txt -p 7242
