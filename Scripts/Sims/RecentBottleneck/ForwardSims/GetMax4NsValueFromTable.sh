...
for k in {3..3}
do
ResultsFile="../../../../Results/RecentBottleneck/ForwardSims/"${Dir[$i]}"/HapLengths/ExitFileNoRecN"${NumberOfMarkers[$k]}".txt"
DataSummarized="../../../../Results/ResultsSelectionInferred/SelectionRecentBottleneck"${Selection[$i]}"_N"${NumberOfMarkers[$k]}".txt"
