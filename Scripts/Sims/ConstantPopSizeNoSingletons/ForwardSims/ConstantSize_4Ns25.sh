...
time perl GetListOfRunsWhereFrequencyMatches.pl 0.01 0.01 ../../../../Results/ConstantPopSize/ForwardSims/4Ns_25/Output.$SLURM_ARRAY_TASK_ID.full_out.txt ../../../../Results/ConstantPopSize/ForwardSims/4Ns_25/Alleles_$SLURM_ARRAY_TASK_ID.txt 0 160000

File="../../../../Results/ConstantPopSize/ForwardSims/4Ns_25/Output."$SLURM_ARRAY_TASK_ID".full_out.txt"
