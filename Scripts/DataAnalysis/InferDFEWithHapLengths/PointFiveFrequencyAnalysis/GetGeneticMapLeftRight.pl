...
open (EXCLUSION,"../../../../Data/VariantNumberPointFive.txt") or die "NO!";
open (PERRECVAR,">../../../../Data/LeftBpRecRatePerVariantPointFive.txt") or die "NO!";
@VariantsToExclude = ();
...
$GeneticMapFile = "../../../../Data/Plink/MissensePointFivePercent".$i.".frq";
...
open (PERRECVAR,">../../../../Data/RightBpRecRatePerVariantPointFive.txt") or die "NO!";
