...
ResampledTrajFile="../../../../Results/UK10KHighPopSize/ForwardSims/4Ns_0/ResampledTraj"$SGE_TASK_ID".txt"
MsselOut="../../../../Results/UK10KHighPopSize/ForwardSims/4Ns_0/MsselOut"$SGE_TASK_ID".txt"
HapLengths="../../../../Results/UK10KHighPopSize/ForwardSims/4Ns_0/HapLength"$SGE_TASK_ID".txt"
MsselOutNoRec="../../../../Results/UK10KHighPopSize/ForwardSims/4Ns_0/MsselOutNoRec"$SGE_TASK_ID".txt"
HapLengthsNoRec="../../../../Results/UK10KHighPopSize/ForwardSims/4Ns_0/HapLengthNoRec"$SGE_TASK_ID".txt"
MsselOutNoRecAnc="../../../../Results/UK10KHighPopSize/ForwardSims/4Ns_0/MsselOutNoRecAnc"$SGE_TASK_ID".txt"
HapLengthsNoRecAnc="../../../../Results/UK10KHighPopSize/ForwardSims/4Ns_0/HapLengthNoRecAnc"$SGE_TASK_ID".txt"

MsselOutMultiSeq="../../../../Results/UK10KHighPopSize/ForwardSims/4Ns_0/MsselOutMultiSeq"$SGE_TASK_ID".txt"
HapLengthsMultiSeq="../../../../Results/UK10KHighPopSize/ForwardSims/4Ns_0/HapLengthMultiSeq"$SGE_TASK_ID".txt"
T2File="../../../../Results/UK10KHighPopSize/ForwardSims/4Ns_0/T2Values"$SGE_TASK_ID".txt"
...
for i in {3..3}
do
HapLengths="../../../../Results/UK10KHighPopSize/ForwardSims/4Ns_0/HapLengthN"${NumberOfMarkers[$i]}"_"$SGE_TASK_ID".txt"
HapLengthsNoRec="../../../../Results/UK10KHighPopSize/ForwardSims/4Ns_0/HapLengthNoRecN"${NumberOfMarkers[$i]}"_"$SGE_TASK_ID".txt"
HapLengthsMultiSeq="../../../../Results/UK10KHighPopSize/ForwardSims/4Ns_0/HapLengthMultiSeqN"${NumberOfMarkers[$i]}"_"$SGE_TASK_ID".txt"
HapLengthsNoRecAnc="../../../../Results/UK10KHighPopSize/ForwardSims/4Ns_0/HapLengthNoRecAncN"${NumberOfMarkers[$i]}"_"$SGE_TASK_ID".txt"
HapLengthsRecAware="../../../../Results/UK10KHighPopSize/ForwardSims/4Ns_0/HapLengthRecAwareN"${NumberOfMarkers[$i]}"_"$SGE_TASK_ID".txt"
DistancesFileOne="../../../../Results/UK10KHighPopSize/ForwardSims/4Ns_0/SimDistancesPartOneMssel"${NumberOfMarkers[$i]}"_"$SGE_TASK_ID".txt"
DistancesFileTwo="../../../../Results/UK10KHighPopSize/ForwardSims/4Ns_0/SimDistancesPartTwoMssel"${NumberOfMarkers[$i]}"_"$SGE_TASK_ID".txt"
DistancesFile="../../../../Results/UK10KHighPopSize/ForwardSims/4Ns_0/SimDistancesMssel"${NumberOfMarkers[$i]}"_"$SGE_TASK_ID".txt"
