$ExitFile = "../../../../Results/PopExpansionCEU/ImportanceSamplingSims/SumDistancesFile10000.txt";
...
for ( $k = 1; $k <= 1; $k++ ){
$InputFile = "../../../../Results/PopExpansionCEU/ImportanceSamplingSims/DistancesFile10000_".$j."_".$k.".txt";
