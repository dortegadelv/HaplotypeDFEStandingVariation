setwd("/Users/vicentediegoortegadelvecchyo/Documents/DissertationThesis/PurifyingSelection/Drafts/PaperResults/SimsResults/AlleleAges/")

pdf("AlleleAgesConstantPopSize.pdf")
par(mar=c(5,5,4,2) + 0.1)   

Data <- read.table("AgesConstantPopSize_4Ns_0.txt")

Color <- col2rgb("black")
plot(density(Data$V1[5000:1]),xlab="Generations",ylab="Mean Allele Frequency",type="l",ylim=c(0,0.015),main="Average of more than 10,000 trajectories per every 4Ns",xaxt="n",cex.lab=2,cex.main=1.3,cex.axis=1.5,lwd=3)
#lines(Data$V1[10000:1],ISData$V2[1:10000],lwd=10,col=rgb(Color[1,1],Color[2,1],Color[3,1],100,maxColorValue=255))

Data <- read.table("AgesConstantPopSize_4Ns_-50.txt")

Color <- col2rgb("purple")
lines(density(Data$V1[5000:1]),col="purple",lwd=3)

#lines(Data$V1[10000:1],ISData$V3[1:10000],lwd=10,col=rgb(Color[1,1],Color[2,1],Color[3,1],100,maxColorValue=255))

Data <- read.table("AgesConstantPopSize_4Ns_-100.txt")

Color <- col2rgb("orange")
lines(density(Data$V1[5000:1]),col="orange",lwd=3)

#lines(Data$V1[10000:1],ISData$V4[1:10000],lwd=10,col=rgb(Color[1,1],Color[2,1],Color[3,1],100,maxColorValue=255))

Data <- read.table("AgesConstantPopSize_4Ns_50.txt")

lines(density(Data$V1[5000:1]),col="red",lty="dashed",lwd=3)

Data <- read.table("AgesConstantPopSize_4Ns_100.txt")

lines(density(Data$V1[5000:1]),col="dodgerblue",lty="dashed",lwd=3)
...
pdf("AlleleAgesPopExpansion.pdf")
par(mar=c(5,5,4,2) + 0.1)   

Data <- read.table("AgesPopExpansion_4Ns_0.txt")
...
Data <- read.table("AgesPopExpansion_4Ns_-50.txt")
...
Data <- read.table("AgesPopExpansion_4Ns_-100.txt")
...
Data <- read.table("AgesPopExpansion_4Ns_50.txt")
...
Data <- read.table("AgesPopExpansion_4Ns_100.txt")
...
pdf("AlleleAgesAncientBottleneck.pdf")
par(mar=c(5,5,4,2) + 0.1)   

Data <- read.table("AgesAncientBottleneck_4Ns_0.txt")
...
Data <- read.table("AgesAncientBottleneck_4Ns_-50.txt")
...
Data <- read.table("AgesAncientBottleneck_4Ns_-100.txt")
...
Data <- read.table("AgesAncientBottleneck_4Ns_50.txt")

lines(Data$V1[5000:1],Data$V2[1:5000],col="red",lty="dashed",lwd=3)
lines(Data$V1[5000:1],Data$V3[1:5000],lty=3,col="red")
lines(Data$V1[5000:1],Data$V4[1:5000],lty=3,col="red")

Data <- read.table("AgesAncientBottleneck_4Ns_100.txt")
...
pdf("AlleleAgesRecentBottleneck.pdf")
par(mar=c(5,5,4,2) + 0.1)   

Data <- read.table("AgesRecentBottleneck_4Ns_0.txt")
...
Data <- read.table("AgesRecentBottleneck_4Ns_-50.txt")
...
Data <- read.table("AgesRecentBottleneck_4Ns_-100.txt")
...
Data <- read.table("AgesRecentBottleneck_4Ns_50.txt")

lines(Data$V1[5000:1],Data$V2[1:5000],col="red",lty="dashed",lwd=3)
lines(Data$V1[5000:1],Data$V3[1:5000],lty=3,col="red")
lines(Data$V1[5000:1],Data$V4[1:5000],lty=3,col="red")

Data <- read.table("AgesRecentBottleneck_4Ns_100.txt")
...
pdf("AlleleAgesMediumBottleneck.pdf")
par(mar=c(5,5,4,2) + 0.1)   

Data <- read.table("AgesMediumBottleneck_4Ns_0.txt")
...
Data <- read.table("AgesMediumBottleneck_4Ns_-50.txt")
...
Data <- read.table("AgesMediumBottleneck_4Ns_-100.txt")
...
Data <- read.table("AgesMediumBottleneck_4Ns_50.txt")

lines(Data$V1[5000:1],Data$V2[1:5000],col="red",lty="dashed",lwd=3)
lines(Data$V1[5000:1],Data$V3[1:5000],lty=3,col="red")
lines(Data$V1[5000:1],Data$V4[1:5000],lty=3,col="red")

Data <- read.table("AgesMediumBottleneck_4Ns_100.txt")
