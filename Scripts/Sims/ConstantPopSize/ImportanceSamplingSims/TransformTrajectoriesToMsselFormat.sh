...
ExitFileOne="../../../../Results/ConstantPopSize/ImportanceSamplingSims/ExitMsselPrev_0.01_0_"$i".txtTrajectory.txt"
ExitFileTwo="../../../../Results/ConstantPopSize/ImportanceSamplingSims/ExitMssel_0.01_0_"$i".txtTrajectory.txt"
