...
HapLengths=$DirToCreate"HapLengthsLessDifRecRateNS"$k".txt"
...
Line[7]="../../../Programs/Mssel/mssel3 41 300 1 40 $ResampledTrajectory 250000 -r tbs 499999 -t 1200 -eN 0.0 1.0 -eN 0.0005 0.1 -seeds $k $k $k"
Line[8]="../../../Programs/Mssel/mssel3 41 300 1 40 $ResampledTrajectory 250000 -r tbs 499999 -t 1200 -eN 0.0 1.0 -eN 0.0005 0.1 -seeds $k $k $k"
# Bases = Theta /(4Nu) = 120/(4*5000*1.2e-8) = 500000
