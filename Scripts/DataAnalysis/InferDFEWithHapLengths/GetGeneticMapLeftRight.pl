...
open (EXCLUSION,"../../../Data/Plink/CpGMisOnePercentNumberPositionsVar.txt") or die "NO!";
open (PERRECVAR,">../../../Data/LeftBpRecRatePerVariantNoCpG.txt") or die "NO!";
@VariantsToExclude = ();
...
open (PERRECVAR,">../../../Data/RightBpRecRatePerVariantNoCpG.txt") or die "NO!";
