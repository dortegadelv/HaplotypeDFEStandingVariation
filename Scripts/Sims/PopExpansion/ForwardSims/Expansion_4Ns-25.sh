...
time perl ../../ConstantPopSize/ForwardSims/GetListOfRunsWhereFrequencyMatches.pl 0.01 0.01 ../../../../Results/PopExpansion/ForwardSims/4Ns_-25/Output.$SLURM_ARRAY_TASK_ID.full_out.txt ../../../../Results/PopExpansion/ForwardSims/4Ns_-25/Alleles_$SLURM_ARRAY_TASK_ID.txt 0 80100

File="../../../../Results/PopExpansion/ForwardSims/4Ns_-25/Output."$SLURM_ARRAY_TASK_ID".full_out.txt"
