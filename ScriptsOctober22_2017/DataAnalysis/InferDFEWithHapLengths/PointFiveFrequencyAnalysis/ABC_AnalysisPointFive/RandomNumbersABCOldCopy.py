...
#   FractionTwo = NeThree / (float(NeInitial))
   ...
   GensThree = (920.0 * ( 0.0000000236 / MutationRate)) / (4.0*float(int (NeInitial)))
   FractionThree =  NeThree / (float(int (NeInitial )))
   
   GensFour =  ( 2040.0 * ( 0.0000000236 / MutationRate)) / (4.0*float(int (NeInitial)))
   FractionFour = NeThree / (float(int (NeInitial)))
   
   GensFive = ( (5920.0 * ( 0.0000000236 / MutationRate) )) / (4.0*float(int (NeInitial)))
   FractionFive = 12000 / (float(int (NeInitial )))
   
   String = str(Theta) + " " + str(RecRateRegion) + " " + str(GensOne) + " " + str(FractionOne) + " " + str(GensBot) + " " + str(FractionBot) + " " + str(GensThree) + " " + str(FractionThree) + " " + str(GensFour) + " " + str(FractionFour) + " " + str(GensFive) + " " + str(FractionFive) + "\n"
   RandFile.write(String)
   
   String = str(Theta) + " " + str(RightRecRateRegion) + " " + str(GensOne) + " " + str(FractionOne) + " " + str(GensBot) + " " + str(FractionBot) + " " + str(GensThree) + " " + str(FractionThree) + " " + str(GensFour) + " " + str(FractionFour) + " " + str(GensFive) + " " + str(FractionFive) + "\n"
...
Ne = 2.0 * NeThree
String = String + str(int(Ne*Fraction+0.5)) + " " + str(int ((1500 - TimeTwo)*Fraction + 0.5 )) + "\n"
