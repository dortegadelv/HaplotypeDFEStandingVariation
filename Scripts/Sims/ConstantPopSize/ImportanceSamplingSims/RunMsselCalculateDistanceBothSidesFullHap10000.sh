...
DistancesFile="../../../../Results/ConstantPopSize/ImportanceSamplingSims/DistancesFileBothSidesFullHap10000_"$FileNumber"_"$Repetition".txt"
...
# for k in {1..1000}
# do
../../../../Programs/Mssel/mssel3 41 100 1 40 $ExitMssel 250000 -r 200 499999 -t 240 -seeds $SeedNumber $SeedNumber $SeedNumber > $MsselFile
# done
# time perl ../../ConcatenateManyStatisticsScripts/DistanceToFirstSegregatingSiteMultiSequence_NoSingletonsBothSides.pl $MsselOut $DistancesFile 1 40
time perl ../../ConcatenateManyStatisticsScripts/DistanceToFirstSegregatingSiteMultiSequenceFractionsIncludeSingletonsBothSidesFullHap.pl $MsselFile $DistancesFile 1 40 0 0 25 500000 TestT2Bounds_FullHap.txt
else
