...
MutationRate <- 1.5e-8
SitesDemography <- (4594 * 22971 + 9109 * 1221 + 1171 * 352 + 1496 * 244 + 226252 * 46) * NumberOfNonCpGSites * MutationRate * 5 * 5
...
pdf("../Figures/AltFigure9_UK10KDFE_StandingNew.pdf",width=19)
...
pdf("../Figures/AltFigure9_BarPlot_UK10KDFE_StandingNew.pdf",width=19)
par(mar=c(5.1,5.1,4.1,2.1))
...
ViridisColors <- viridis(4, alpha = 0.7)
pdf("../Figures/AltFigure9_BarPlot_UK10KDFE_StandingNew_OnlyThreeBins.pdf",width=19)
par(mar=c(5.1,5.1,4.1,2.1))
...
ViridisColors <- viridis(4, alpha = 0.7)
pdf("../Figures/AltFigure9_BarPlot_UK10KDFE_StandingNew_OnlyThreeBins_NaturalScale.pdf",width=19)
par(mar=c(5.1,5.1,4.1,2.1))
barplot(logcounts + 0.01, main="", ylab="Probability", xlab="4Ns", col=ViridisColors,
legend = c(expression("Inferred " ~ 'P'[psi] ~ "(" *bolditalic(s[j])*" | 1%" * ", "* italic(D) * ")"), expression("Inferred" ~ 'P'[psi] ~ "(" * bolditalic(s[j]) * ")"), expression("Boyko et al 2008 " ~ 'P'[psi] ~ "(" * bolditalic(s[j]) * ")") , expression("Kim et al 2017 " ~ 'P'[psi] ~ "(" * bolditalic(s[j]) * ")") ), ylim = c(-0.01, 1.2), beside=TRUE,cex.lab=2,cex.axis=2,cex.names=2, args.legend = list(x = "top",cex=2), yaxt="n")
