...
File="ExpansionDenserGrid/ExitMssel_0.01_0_"$SGE_TASK_ID".txtTrajectory.txt"
ExitMssel="ExpansionDenserGrid/TrajParTrajPartMsselOut_"$SGE_TASK_ID".txt"
MsselFile="MsselFiles/MsselFileOut_"$SGE_TASK_ID".txt"
DistancesFile="ExpansionDenserGrid/DistancesFile_"$SGE_TASK_ID".txt"
...
# for k in {1..1000}
# do
../mssel3 3 1000 1 2 $ExitMssel 1 -r 1000 500000 -t 1000 -eN 0.0 1.0 -eN 0.0005 0.1 >> $MsselFile
# done
