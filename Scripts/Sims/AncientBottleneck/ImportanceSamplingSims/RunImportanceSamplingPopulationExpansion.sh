...
time ../../../../Programs/ISProgram/FoIS -A $SelectionCoef2 -a $SelectionCoef1 -f ${Frequency[$FrequencyNumber]} -r 1000 -N 10000 -s $Seed -F ../../../../Results/AncientBottleneck/ImportanceSamplingSims/$File -b ../../ConstantPopSize/ImportanceSamplingSims/Bounds.txt -D DemHistBottleneck.txt -X ../../AncientBottleneck/ImportanceSamplingSims/NewSelectionValues.txt -p 4000
