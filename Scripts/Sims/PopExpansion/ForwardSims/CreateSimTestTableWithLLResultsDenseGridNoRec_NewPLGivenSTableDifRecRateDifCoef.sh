...
ResultsFile="../../../../Results/PopExpansion/ForwardSims/${FourNs[$i]}/LLDataCoefNum$j""_""$SLURM_ARRAY_TASK_ID.txt"
...
perl ../../UK10K_PointTwoPercenters/ForwardSims/CalculatePLengthGivenSQuantileCloseQuantileNew.pl $HapFilePrefix 250000 ../../../../Results/UK10K_OnePercenters/ImportanceSamplingSims/Quantile TestBounds.txt $ResultsFile ../../../../Data/LeftBpRecRatePerVariantNoCpG.txt ../../../../Data/RightBpRecRatePerVariantNoCpG.txt 300 VariantNumber.txt ../../UK10K_PointTwoPercenters/ForwardSims/MissenseOnePercentNoCpG.txt 565630 PLGivenSTableWithRecs$j.txt

for l in {0..299}
do
CurrentFile="../../../../Results/PopExpansion/ForwardSims/${FourNs[$i]}/LLDataCoefNum$j""_""$SLURM_ARRAY_TASK_ID.txt"$l".txt"
rm $CurrentFile
done
