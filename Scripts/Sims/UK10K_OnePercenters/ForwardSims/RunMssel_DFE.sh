...
# TrajNum=$( wc -l ../../../../Results/UK10K/ForwardSims/DFETest/Alleles{1..1000}.txt | tail -n1 | awk '{print $1}' )
# echo $TrajNum
...
ResampledTrajFile="../../../../Results/UK10K/ForwardSims/DFETest/ResampledTraj"$SLURM_ARRAY_TASK_ID".txt"
MsselOut="../../../../Results/UK10K/ForwardSims/DFETest/MsselOut"$SLURM_ARRAY_TASK_ID".txt"
HapLengths="../../../../Results/UK10K/ForwardSims/DFETest/HapLength"$SLURM_ARRAY_TASK_ID".txt"
MsselOutNoRec="../../../../Results/UK10K/ForwardSims/DFETest/MsselOutNoRec"$SLURM_ARRAY_TASK_ID".txt"
HapLengthsNoRec="../../../../Results/UK10K/ForwardSims/DFETest/HapLengthNoRec"$SLURM_ARRAY_TASK_ID".txt"
MsselOutNoRecAnc="../../../../Results/UK10KForwardSims/DFETest/MsselOutNoRecAnc"$SLURM_ARRAY_TASK_ID".txt"
HapLengthsNoRecAnc="../../../../Results/UK10K/ForwardSims/DFETest/HapLengthNoRecAnc"$SLURM_ARRAY_TASK_ID".txt"

MsselOutMultiSeq="../../../../Results/UK10K/ForwardSims/DFETest/MsselOutMultiSeq"$SLURM_ARRAY_TASK_ID".txt"
HapLengthsMultiSeq="../../../../Results/UK10K/ForwardSims/DFETest/HapLengthMultiSeq"$SLURM_ARRAY_TASK_ID".txt"
T2File="../../../../Results/UK10K/ForwardSims/DFETest/T2Values"$SLURM_ARRAY_TASK_ID".txt"
...
# cat ../../../../Results/UK10K/ForwardSims/DFETest/TrajMsselLike.txt | ../stepftn > ../../../../Results/UK10K/ForwardSims/DFETest/ReducedTrajectories10000.txt
...
HapLengths="../../../../Results/UK10K/ForwardSims/DFETest/HapLengthN"${NumberOfMarkers[$i]}"_"$Reps".txt"
HapLengthsNoRec="../../../../Results/UK10K/ForwardSims/DFETest/HapLengthNoRecN"${NumberOfMarkers[$i]}"_"$Reps".txt"
HapLengthsMultiSeq="../../../../Results/UK10K/ForwardSims/DFETest/HapLengthMultiSeqN"${NumberOfMarkers[$i]}"_"$Reps".txt"
HapLengthsNoRecAnc="../../../../Results/UK10K/ForwardSims/DFETest/HapLengthNoRecAncN"${NumberOfMarkers[$i]}"_"$Reps".txt"
HapLengthsRecAware="../../../../Results/UK10K/ForwardSims/DFETest/HapLengthRecAwareN"${NumberOfMarkers[$i]}"_"$Reps".txt"
DistancesFileOne="../../../../Results/UK10K/ForwardSims/DFETest/SimDistancesPartOneMssel"${NumberOfMarkers[$i]}"_"$Reps".txt"
DistancesFileTwo="../../../../Results/UK10K/ForwardSims/DFETest/SimDistancesPartTwoMssel"${NumberOfMarkers[$i]}"_"$Reps".txt"
DistancesFile="../../../../Results/UK10K/ForwardSims/DFETest/SimDistancesMssel"${NumberOfMarkers[$i]}"_"$Reps".txt"
SamplesFile="../../../../Results/UK10K/ForwardSims/DFETest/SamplesToCheckMssel"${NumberOfMarkers[$i]}"_"$Reps".txt"
...
for ChrNum in {69..76}
do
Value[$ChrNum]=$( grep 'age' ../../../../Results/UK10K/ForwardSims/DFETest/ReducedTrajectories_$ChrNum.txt | wc -l )
done
...
perl ../../ConstantPopSize/ForwardSims/SampleTrajectories.pl ../../../../Results/UK10K/ForwardSims/DFETest/ReducedTrajectories_$ChrNum.txt 1 $ResampledTrajFile $RandomSeed
