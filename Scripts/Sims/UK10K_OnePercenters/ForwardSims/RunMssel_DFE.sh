...
MsselOutNoRecAnc="../../../../Results/UK10K/ForwardSims/DFETest/MsselOutNoRecAnc"$SLURM_ARRAY_TASK_ID".txt"
...
for i in {3..3}
do
HapLengths="../../../../Results/UK10K/ForwardSims/DFETest/HapLengthN"${NumberOfMarkers[$i]}"_"$SLURM_ARRAY_TASK_ID".txt"
HapLengthsNoRec="../../../../Results/UK10K/ForwardSims/DFETest/HapLengthNoRecN"${NumberOfMarkers[$i]}"_"$SLURM_ARRAY_TASK_ID".txt"
HapLengthsMultiSeq="../../../../Results/UK10K/ForwardSims/DFETest/HapLengthMultiSeqN"${NumberOfMarkers[$i]}"_"$SLURM_ARRAY_TASK_ID".txt"
HapLengthsNoRecAnc="../../../../Results/UK10K/ForwardSims/DFETest/HapLengthNoRecAncN"${NumberOfMarkers[$i]}"_"$SLURM_ARRAY_TASK_ID".txt"
HapLengthsRecAware="../../../../Results/UK10K/ForwardSims/DFETest/HapLengthRecAwareN"${NumberOfMarkers[$i]}"_"$SLURM_ARRAY_TASK_ID".txt"
DistancesFileOne="../../../../Results/UK10K/ForwardSims/DFETest/SimDistancesPartOneMssel"${NumberOfMarkers[$i]}"_"$SLURM_ARRAY_TASK_ID".txt"
DistancesFileTwo="../../../../Results/UK10K/ForwardSims/DFETest/SimDistancesPartTwoMssel"${NumberOfMarkers[$i]}"_"$SLURM_ARRAY_TASK_ID".txt"
DistancesFile="../../../../Results/UK10K/ForwardSims/DFETest/SimDistancesMssel"${NumberOfMarkers[$i]}"_"$SLURM_ARRAY_TASK_ID".txt"


perl ../../ConstantPopSize/ForwardSims/SampleTrajectories.pl ../../../../Results/UK10K/ForwardSims/DFETest/ReducedTrajectories50000.txt 273 $ResampledTrajFile $SLURM_ARRAY_TASK_ID
