...
DataTable <- c("../Results/ISPopExpansionTables/TableToTestPopExpansion100GensAgo.txt","../Results/ISPopExpansionTables/TableToTestPopExpansion1000GensAgo.txt","../Results/ISPopExpansionTables/TableToTestPopExpansion10000GensAgo.txt","../Results/ISPopExpansionTables/TableToTestPopExpansion100000GensAgo.txt")

FigureTitles <- c("L Probability Distribution Differences\nExpansion time = 100 Generations ago","L Probability Distribution Differences\nExpansion time = 1,000 Generations ago","L Probability Distribution Differences\nExpansion time = 10,000 Generations ago","L Probability Distribution Differences\nExpansion time = 100,000 Generations ago")
...
pdf(Plot, width = 7*5, height = 7*5)
par(mfrow=c(6,6), mar=c(5,7,5,6) + 0.1)
...
DataTableOne <- read.table (DataTable[1])
Differences <- c()
Pchs <- c(3, 4, 8, 9, 19)

InitialValue <- c(183, 193, 203, 213, 223)
# InitialValue <- c(103)
for (Num in 1:5){
...
if (Val == 183){
    ...
    plot(Differences, col=ViridisColors[Num], type = "b", lty= "dotdash", ylim = c(0,0.8), pch = Pchs[Num], ylab = "Absolute difference between probability distributions of L\n using 4Ns = J vs 4Ns = K", xaxt = "n", xlab = "Compared 4Ns value \'K\'",cex.lab=2, cex.axis=2, main = FigureTitles[1],cex.main=2.2)
}else{
    lines(Differences, col = ViridisColors[Num], type = "b", lty= "dotdash", pch = Pchs[Num])
}
}

axis(1, at = c(1,101,201,301,401), labels = c("-200","-100", "0", "100", "200"), cex.axis = 2 )
legend("top", c("-20","-10","0","10","20"), col = ViridisColors , pch = c(3, 4, 8, 9, 19), title = "Focal 4Ns value \'J\'", cex = 2, bty= 'n')
...
Max <- max(DistributionOfL)
Min <- min(DistributionOfL)
plot(1:6,DistributionOfL[1,], col=ColorViridis[3], type="l", lwd=6, ylim=c(Min,Max), ylab="Probability", xlab="L", cex.lab=2.5, cex.axis=2.5, xaxt="n", main="Probability Distribution of L\nExpansion time = 1000 generations ago", cex.main=2.2)
lines(1:6,DistributionOfL[2,],col=ColorViridis[2],lwd=6)
lines(1:6,DistributionOfL[3,],col=ColorViridis[1],lwd=6)
lines(1:6,DistributionOfL[4,],col=ColorViridis[4],lty=5,lwd=6)
lines(1:6,DistributionOfL[5,],col=ColorViridis[5],lty=5,lwd=6)
...
DataTableOne <- read.table (DataTable[2])
Differences <- c()
Pchs <- c(3, 4, 8, 9, 19)
...
if (Val == 183){
    ...
    plot(Differences, col=ViridisColors[Num], type = "b", lty= "dotdash", ylim = c(0,0.8), pch = Pchs[Num], ylab = "Absolute difference between probability distributions of L\n using 4Ns = J vs 4Ns = K", xaxt = "n", xlab = "Compared 4Ns value \'K\'",cex.lab=2, cex.axis=2, main = FigureTitles[2],cex.main=2.2)
}else{
    lines(Differences, col = ViridisColors[Num], type = "b", lty= "dotdash", pch = Pchs[Num])
}
}
...
Max <- max(DistributionOfL)
Min <- min(DistributionOfL)
plot(1:6,DistributionOfL[1,], col=ColorViridis[3], type="l", lwd=6, ylim=c(Min,Max), ylab="Probability", xlab="L", cex.lab=2.5, cex.axis=2.5, xaxt="n", main="Probability Distribution of L\nExpansion time = 10000 generations ago", cex.main=2.2)
lines(1:6,DistributionOfL[2,],col=ColorViridis[2],lwd=6)
lines(1:6,DistributionOfL[3,],col=ColorViridis[1],lwd=6)
lines(1:6,DistributionOfL[4,],col=ColorViridis[4],lty=5,lwd=6)
lines(1:6,DistributionOfL[5,],col=ColorViridis[5],lty=5,lwd=6)
...
DataTableOne <- read.table (DataTable[3])
Differences <- c()
Pchs <- c(3, 4, 8, 9, 19)
...
if (Val == 183){
    ...
    plot(Differences, col=ViridisColors[Num], type = "b", lty= "dotdash", ylim = c(0,0.8), pch = Pchs[Num], ylab = "Absolute difference between probability distributions of L\n using 4Ns = J vs 4Ns = K", xaxt = "n", xlab = "Compared 4Ns value \'K\'",cex.lab=2, cex.axis=2, main = FigureTitles[3],cex.main=2.2)
}else{
    lines(Differences, col = ViridisColors[Num], type = "b", lty= "dotdash", pch = Pchs[Num])
}
}
...
############## Trajectories
    ...
    plot(Data$V1[20000:1],Data$V2[1:20000],xlab="Time before the present",ylab="Mean Allele Frequency",type="l",xlim=c(0,20000),ylim=c(0,0.011),main="Average Frequency Trajectory\nExpansion time = 100000 generations ago",xaxt="n",cex.lab=2.5,cex.main=2.2,cex.axis=2.5,lwd=6,col=ColorViridis[3])
#lines(Data$V1[5000:1],Data$V3[1:5000],lty=3)
#lines(Data$V1[5000:1],Data$V4[1:5000],lty=3)
#lines(Data$V1[10000:1],ISData$V2[1:10000],lwd=10,col=rgb(Color[1,1],Color[2,1],Color[3,1],100,maxColorValue=255))
...
Max <- max(DistributionOfL)
Min <- min(DistributionOfL)
plot(1:6,DistributionOfL[1,], col=ColorViridis[3], type="l", lwd=6, ylim=c(Min,Max), ylab="Probability", xlab="L", cex.lab=2.5, cex.axis=2.5, xaxt="n", main="Probability Distribution of L\nExpansion time = 100000 generations ago", cex.main=2.2)
lines(1:6,DistributionOfL[2,],col=ColorViridis[2],lwd=6)
lines(1:6,DistributionOfL[3,],col=ColorViridis[1],lwd=6)
lines(1:6,DistributionOfL[4,],col=ColorViridis[4],lty=5,lwd=6)
lines(1:6,DistributionOfL[5,],col=ColorViridis[5],lty=5,lwd=6)
...
DataTableOne <- read.table (DataTable[4])
Differences <- c()
Pchs <- c(3, 4, 8, 9, 19)
...
if (Val == 183){
    ...
    plot(Differences, col=ViridisColors[Num], type = "b", lty= "dotdash", ylim = c(0,0.8), pch = Pchs[Num], ylab = "Absolute difference between probability distributions of L\n using 4Ns = J vs 4Ns = K", xaxt = "n", xlab = "Compared 4Ns value \'K\'",cex.lab=2, cex.axis=2, main = FigureTitles[4],cex.main=2.2)
}else{
    lines(Differences, col = ViridisColors[Num], type = "b", lty= "dotdash", pch = Pchs[Num])
}
}
