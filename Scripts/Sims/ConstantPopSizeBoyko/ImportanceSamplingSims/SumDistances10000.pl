$ExitFile = "../../../../Results/ConstantPopSizeBoyko/ImportanceSampling/SumDistancesFile10000.txt";
...
for ( $k = 1; $k <= 10; $k++ ){
$InputFile = "../../../../Results/ConstantPopSizeBoyko/ImportanceSampling/DistancesFile10000_".$j."_".$k.".txt";
