...
File="../../../../Results/PopExpansionFifty/ImportanceSamplingSims/ExitMssel_0.01_0_"$FileNumber".txtTrajectory.txt"
ExitMssel="../../../../Results/PopExpansionFifty/ImportanceSamplingSims/TrajParTrajPartMsselOut_"$FileNumber"_"$Repetition".txt"
MsselFile="../../../../Results/PopExpansionFifty/ImportanceSamplingSims/MsselFileOut_"$FileNumber"_"$Repetition".txt"
DistancesFile="../../../../Results/PopExpansionFifty/ImportanceSamplingSims/DistancesFile10000_"$FileNumber"_"$Repetition".txt"
...
for i in {1..1000}
do
perl ../../ConstantPopSize/ImportanceSamplingSims/TrajectoryPartMssel.pl $File $i $ExitMssel 8302
...
# for k in {1..1000}
# do
../../../../Programs/Mssel/mssel3 41 100 1 40 $ExitMssel 1 -r 0.0 250000 -t 449.040000000000000 -eN 0.0 1.0 -eN .000885221806520 .111905398182789 -seeds $SeedNumber $SeedNumber $SeedNumber > $MsselFile
# done
