...
time GSL_RNG_SEED=$SGE_TASK_ID GSL_RNG_TYPE=mrg ../../../../Programs/PReFeRSim/fwd_seldist_gsl_2012_4epoch.debug ParameterFile_DFEMouseHighPop.txt $SGE_TASK_ID

time perl ../../ConstantPopSize/ForwardSims/GetListOfRunsWhereFrequencyMatches.pl 0.0095 0.0105 ../../../../Results/UK10K/ForwardSims/DFETestMouseHighPop/Output.$SGE_TASK_ID.full_out.txt ../../../../Results/UK10K/ForwardSims/DFETestMouseHighPop/Alleles_$SGE_TASK_ID.txt 0 24834

File="../../../../Results/UK10K/ForwardSims/DFETestMouseHighPop/Output."$SGE_TASK_ID".full_out.txt"

# rm $File

time GSL_RNG_SEED=$SGE_TASK_ID GSL_RNG_TYPE=mrg ../../../../Programs/PReFeRSim/fwd_seldist_gsl_2012_4epoch.debug ParameterFile_DFE_BMouseHighPop.txt $SGE_TASK_ID
