...
DistancesFile="../../../../Results/ConstantPopSize/ImportanceSamplingSims/DistancesFileBothSides10000_"$FileNumber"_"$Repetition".txt"
...
time perl ../../ConcatenateManyStatisticsScripts/DistanceToFirstSegregatingSiteMultiSequenceFractionsIncludeSingletonsBothSides.pl $MsselFile $DistancesFile 1 40 0 0 25 250000 TestT2Bounds.txt
else
