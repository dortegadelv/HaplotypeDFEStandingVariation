...
ResampledTrajFile="../../../../Results/UK10K/ForwardSims/DFETestMouse/ResampledTraj"$SGE_TASK_ID".txt"
MsselOut="../../../../Results/UK10K/ForwardSims/DFETestMouse/MsselOut"$SGE_TASK_ID".txt"
HapLengths="../../../../Results/UK10K/ForwardSims/DFETestMouse/HapLength"$SGE_TASK_ID".txt"
MsselOutNoRec="../../../../Results/UK10K/ForwardSims/DFETestMouse/MsselOutNoRec"$SGE_TASK_ID".txt"
HapLengthsNoRec="../../../../Results/UK10K/ForwardSims/DFETestMouse/HapLengthNoRec"$SGE_TASK_ID".txt"
MsselOutNoRecAnc="../../../../Results/UK10K/ForwardSims/DFETestMouse/MsselOutNoRecAnc"$SGE_TASK_ID".txt"
HapLengthsNoRecAnc="../../../../Results/UK10K/ForwardSims/DFETestMouse/HapLengthNoRecAnc"$SGE_TASK_ID".txt"

MsselOutMultiSeq="../../../../Results/UK10K/ForwardSims/DFETestMouse/MsselOutMultiSeq"$SGE_TASK_ID".txt"
HapLengthsMultiSeq="../../../../Results/UK10K/ForwardSims/DFETestMouse/HapLengthMultiSeq"$SGE_TASK_ID".txt"
T2File="../../../../Results/UK10K/ForwardSims/DFETestMouse/T2Values"$SGE_TASK_ID".txt"
...
for i in {3..3}
do
HapLengths="../../../../Results/UK10K/ForwardSims/DFETestMouse/HapLengthN"${NumberOfMarkers[$i]}"_"$SGE_TASK_ID".txt"
HapLengthsNoRec="../../../../Results/UK10K/ForwardSims/DFETestMouse/HapLengthNoRecN"${NumberOfMarkers[$i]}"_"$SGE_TASK_ID".txt"
HapLengthsMultiSeq="../../../../Results/UK10K/ForwardSims/DFETestMouse/HapLengthMultiSeqN"${NumberOfMarkers[$i]}"_"$SGE_TASK_ID".txt"
HapLengthsNoRecAnc="../../../../Results/UK10K/ForwardSims/DFETestMouse/HapLengthNoRecAncN"${NumberOfMarkers[$i]}"_"$SGE_TASK_ID".txt"
HapLengthsRecAware="../../../../Results/UK10K/ForwardSims/DFETestMouse/HapLengthRecAwareN"${NumberOfMarkers[$i]}"_"$SGE_TASK_ID".txt"
DistancesFileOne="../../../../Results/UK10K/ForwardSims/DFETestMouse/SimDistancesPartOneMssel"${NumberOfMarkers[$i]}"_"$SGE_TASK_ID".txt"
DistancesFileTwo="../../../../Results/UK10K/ForwardSims/DFETestMouse/SimDistancesPartTwoMssel"${NumberOfMarkers[$i]}"_"$SGE_TASK_ID".txt"
DistancesFile="../../../../Results/UK10K/ForwardSims/DFETestMouse/SimDistancesMssel"${NumberOfMarkers[$i]}"_"$SGE_TASK_ID".txt"


perl ../../ConstantPopSize/ForwardSims/SampleTrajectories.pl ../../../../Results/UK10K/ForwardSims/DFETestMouse/ReducedTrajectories50000.txt 273 $ResampledTrajFile $SGE_TASK_ID
