...
Data <- read.table("../Scripts/Sims/PopExpansion/ForwardSims/FullTable.txt")
RecombinationQuantiles <- read.table("../Scripts/Sims/PopExpansion/ForwardSims/QuantilesRecombination.txt")
RecombinationQuantiles <- RecombinationQuantiles * 2

RecValuesOne <- read.table("../Scripts/Sims/PopExpansion/ForwardSims/ResampledBpRecRatePerVariantNoCpG.txt")
RecValuesTwo <- read.table("../Scripts/Sims/PopExpansion/ForwardSims/ResampledBpRecRatePerVariantNoCpG.txt")
...
pdf("../Figures/SuppFigure45_PRLinePopExpansionSims.pdf",width=14,height = 10)
...
plot(SortRecValues,OrderedVector,type="l",main=expression(w[1]), xlab = "Population scaled recombination rate in the region",  ylab = "Probability", cex.lab=1.7, cex.main=2, pch = 3)
...
plot(SortRecValues,OrderedVector,type="l",main=expression(w[2]), xlab = "Population scaled recombination rate in the region",  ylab = "Probability", cex.lab=1.7, cex.main=2, pch = 3)
...
plot(SortRecValues,OrderedVector,type="l",main=expression(w[3]), xlab = "Population scaled recombination rate in the region",  ylab = "Probability", cex.lab=1.7, cex.main=2, pch = 3)
...
plot(SortRecValues,OrderedVector,type="l",main=expression(w[4]), xlab = "Population scaled recombination rate in the region",  ylab = "Probability", cex.lab=1.7, cex.main=2, pch = 3)
...
plot(SortRecValues,OrderedVector,type="l",main=expression(w[5]), xlab = "Population scaled recombination rate in the region",  ylab = "Probability", cex.lab=1.7, cex.main=2, pch = 3)
...
plot(SortRecValues,OrderedVector,type="l",main=expression(w[6]), xlab = "Population scaled recombination rate in the region",  ylab = "Probability", cex.lab=1.7, cex.main=2, pch = 3)
