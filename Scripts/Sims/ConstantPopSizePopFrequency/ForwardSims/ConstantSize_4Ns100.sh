...
#$ -cwd
#$ -N ForWF
#$ -o ../../../../Results/ConstantPopSizePopFrequency/ForwardSims/4Ns_100/Trash
#$ -e ../../../../Results/ConstantPopSizePopFrequency/ForwardSims/4Ns_100/Trash
...
time perl GetListOfRunsWhereFrequencyMatches.pl 0.01 0.01 ../../../../Results/ConstantPopSizePopFrequency/ForwardSims/4Ns_100/Output.$SGE_TASK_ID.full_out.txt ../../../../Results/ConstantPopSizePopFrequency/ForwardSims/4Ns_100/Alleles_$SGE_TASK_ID.txt 0 160000

File="../../../../Results/ConstantPopSizePopFrequency/ForwardSims/4Ns_100/Output."$SGE_TASK_ID".full_out.txt"
