...
$ExitFile = "../../../../Results/ResultsSelectionInferred/SelectionLargerSpaceUK10K".$FourNs[$DirNumber].".txt";
...
$File="../../../../Results/UK10K/ForwardSims/".$FourNs[$DirNumber]."/AnotherLLSimsMssel273_".$RepNumber.".txt";
