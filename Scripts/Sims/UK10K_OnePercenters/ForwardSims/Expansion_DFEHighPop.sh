...
time GSL_RNG_SEED=$SLURM_ARRAY_TASK_ID GSL_RNG_TYPE=mrg ../../../../Programs/PReFeRSim/fwd_seldist_gsl_2012_4epoch.debug ParameterFile_DFEHighPop.txt $SLURM_ARRAY_TASK_ID

time perl ../../ConstantPopSize/ForwardSims/GetListOfRunsWhereFrequencyMatches.pl 0.0095 0.0105 ../../../../Results/UK10K/ForwardSims/DFETestHighPop/Output.$SLURM_ARRAY_TASK_ID.full_out.txt ../../../../Results/UK10K/ForwardSims/DFETestHighPop/Alleles_$SLURM_ARRAY_TASK_ID.txt 0 24834

File="../../../../Results/UK10K/ForwardSims/DFETestHighPop/Output."$SLURM_ARRAY_TASK_ID".full_out.txt"

# rm $File

time GSL_RNG_SEED=$SLURM_ARRAY_TASK_ID GSL_RNG_TYPE=mrg ../../../../Programs/PReFeRSim/fwd_seldist_gsl_2012_4epoch.debug ParameterFile_DFE_BHighPop.txt $SLURM_ARRAY_TASK_ID
