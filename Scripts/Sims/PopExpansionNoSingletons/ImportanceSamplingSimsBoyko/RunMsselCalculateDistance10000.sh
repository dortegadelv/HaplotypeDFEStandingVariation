...
File="../../../../Results/PopExpansionBoyko/ImportanceSamplingSims/ExitMssel_0.01_0_"$FileNumber".txtTrajectory.txt"
ExitMssel="../../../../Results/PopExpansionBoyko/ImportanceSamplingSims/TrajParTrajPartMsselOut_"$FileNumber"_"$Repetition".txt"
MsselFile="../../../../Results/PopExpansionBoyko/ImportanceSamplingSims/MsselFileOut_"$FileNumber"_"$Repetition".txt"
DistancesFile="../../../../Results/PopExpansionBoyko/ImportanceSamplingSims/DistancesFile10000_"$FileNumber"_"$Repetition".txt"
...
for i in {1..1000}
do
perl ../../ConstantPopSize/ImportanceSamplingSims/TrajectoryPartMssel.pl $File $i $ExitMssel 9899
...
# for k in {1..1000}
# do
../../../../Programs/Mssel/mssel3 41 100 1 40 $ExitMssel 1 -r 0.0 250000 -t 719.760000000000000 -eN 0.0 1.0 -eN .000583527842614 .033927975991997 -seeds $SeedNumber $SeedNumber $SeedNumber > $MsselFile
# done
