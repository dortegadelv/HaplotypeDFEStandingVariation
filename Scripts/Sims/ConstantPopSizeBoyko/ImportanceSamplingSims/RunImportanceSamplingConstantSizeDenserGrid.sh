...
time ../../../../Programs/ISProgram/SlatkinISConstantSizeSISR -A $SelectionCoef2 -a $SelectionCoef1 -f ${Frequency[$FrequencyNumber]} -r 1000 -N 20000 -s $Seed -F ../../../../Results/ConstantPopSizeBoyko/ImportanceSampling/$File -b Bounds.txt -D DemographicHistoryConstant.txt -X NewSelectionValues.txt -p 4000
