...
RecRateFile = open ('LeftBpRecRatePerVariantNoCpGSynonymous.txt', 'r')
RecRates = []
LowRecRates = []
...
RecRateFile = open ('RightBpRecRatePerVariantNoCpGSynonymous.txt', 'r')
RightRecRates = []
RightLowRecRates = []
for line in RecRateFile:
...
RandomNumbersFile = "../Results/LeftRandomNumbers" + str(Number) + ".txt"
ParamsFile = "../Results/LeftParameters" + str(Number) + ".txt"

RandFile = open (RandomNumbersFile, 'w')
ParsFile = open (ParamsFile, 'a')

RandomNumbersFile = "../Results/RightRandomNumbers" + str(Number) + ".txt"
ParamsFile = "../Results/RightParameters" + str(Number) + ".txt"

RandFileTwo = open (RandomNumbersFile, 'w')
ParsFileTwo = open (ParamsFile, 'w')

RandomNumbersFile = "../Results/LeftLowRecRandomNumbers" + str(Number) + ".txt"
RandLowRecFile = open (RandomNumbersFile, 'w')

RandomNumbersFile = "../Results/RightLowRecRandomNumbers" + str(Number) + ".txt"
...
ParamsFile = "../Results/PReFerSimParameters" + str(Number) + ".txt"
ParamsFileB = "../Results/PReFerSimParameters" + str(Number) + "_B.txt"

ABCParsFile = open (ParamsFile, 'w')
ABCParsFileB = open (ParamsFileB, 'w')

DemHist = "../Results/ConstantSizeDemHist" + str(Number) + ".txt"
OutDir = "../Results/PReFerSimOutput" + str(Number) + ".txt"
AllelesFile = "../Results/PReFerSimOutputAlleles_" + str(Number) + ".txt"
TrajFile = "../Results/TrajOutputAlleles" + str(Number) + ".txt"
