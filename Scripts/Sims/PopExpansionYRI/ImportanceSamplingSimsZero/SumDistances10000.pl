$ExitFile = "../../../../Results/PopExpansionZero/ImportanceSamplingSims/SumDistancesFile10000.txt";
...
for ( $k = 1; $k <= 1; $k++ ){
$InputFile = "../../../../Results/PopExpansionZero/ImportanceSamplingSims/DistancesFile10000_".$j."_".$k.".txt";
