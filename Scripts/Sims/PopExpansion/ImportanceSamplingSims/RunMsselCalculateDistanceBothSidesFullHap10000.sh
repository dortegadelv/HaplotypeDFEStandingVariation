...
DistancesFile="../../../../Results/PopExpansion/ImportanceSamplingSims/DistancesFileBothSidesFullHap10000_"$FileNumber"_"$Repetition".txt"
...
# for k in {1..1000}
# do
../../../../Programs/Mssel/mssel3 41 100 1 40 $ExitMssel 250000 -r 1000 499999 -t 1200 -eN 0.0 1.0 -eN 0.0005 0.1 -seeds $SeedNumber $SeedNumber $SeedNumber > $MsselFile
# done
