...
############## HF
AlleleCount=$( wc -l ../../../../Results/ConstantPopSize/ForwardSims/4Ns_0/AllelesHF_*.txt | tail -n1 | awk '{print $1}' )
echo $AlleleCount
Reps=$( ls ../../../../Results/ConstantPopSize/ForwardSims/4Ns_0/AllelesHF_*.txt | wc -l )
perl TrajToMsselFormat.pl ../../../../Results/ConstantPopSize/ForwardSims/4Ns_0/TrajHF_ 20000 ../../../../Results/ConstantPopSize/ForwardSims/4Ns_0/TrajMsselLikeHF.txt $AlleleCount 0 $Reps
cat ../../../../Results/ConstantPopSize/ForwardSims/4Ns_0/TrajMsselLikeHF.txt | ../../../../Programs/Mssel/stepftn > ../../../../Results/ConstantPopSize/ForwardSims/4Ns_0/ReducedTrajectoriesHF.txt

AlleleCount=$( wc -l ../../../../Results/ConstantPopSize/ForwardSims/4Ns_50/AllelesHF_*.txt | tail -n1 | awk '{print $1}' )
echo $AlleleCount
Reps=$( ls ../../../../Results/ConstantPopSize/ForwardSims/4Ns_50/AllelesHF_*.txt | wc -l )
perl TrajToMsselFormat.pl ../../../../Results/ConstantPopSize/ForwardSims/4Ns_50/TrajHF_ 20000 ../../../../Results/ConstantPopSize/ForwardSims/4Ns_50/TrajMsselLikeHF.txt $AlleleCount 0 $Reps
cat ../../../../Results/ConstantPopSize/ForwardSims/4Ns_50/TrajMsselLikeHF.txt | ../../../../Programs/Mssel/stepftn > ../../../../Results/ConstantPopSize/ForwardSims/4Ns_50/ReducedTrajectoriesHF.txt

AlleleCount=$( wc -l ../../../../Results/ConstantPopSize/ForwardSims/4Ns_100/AllelesHF_*.txt | tail -n1 | awk '{print $1}' )
echo $AlleleCount
Reps=$( ls ../../../../Results/ConstantPopSize/ForwardSims/4Ns_100/AllelesHF_*.txt | wc -l )
perl TrajToMsselFormat.pl ../../../../Results/ConstantPopSize/ForwardSims/4Ns_100/TrajHF_ 20000 ../../../../Results/ConstantPopSize/ForwardSims/4Ns_100/TrajMsselLikeHF.txt $AlleleCount 0 $Reps
cat ../../../../Results/ConstantPopSize/ForwardSims/4Ns_100/TrajMsselLikeHF.txt | ../../../../Programs/Mssel/stepftn > ../../../../Results/ConstantPopSize/ForwardSims/4Ns_100/ReducedTrajectoriesHF.txt
