...
for k in {3..3}
do
ResultsFile="../../../../Results/ConstantPopSizePopFrequency/ForwardSims/"${Dir[$i]}"/HapLengths/ExitFileNoRecN"${NumberOfMarkers[$k]}".txt"
DataSummarized="../../../../Results/ResultsSelectionInferred/SelectionConstantPopSizePopFrequency"${Selection[$i]}"_N"${NumberOfMarkers[$k]}".txt"
