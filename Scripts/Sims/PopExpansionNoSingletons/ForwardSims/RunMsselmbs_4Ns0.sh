...
TrajNum=$( wc -l TestData/run.2/Alleles{1..300}.txt | tail -n1 | awk '{print $1}' )
echo $TrajNum
...
time perl SampleTrajectories_mbs.pl TestData/run.2/ReducedTrajectories.txt ${NumberOfMarkers[$i]} $Dir $SGE_TASK_ID $PopHistory

TrajPrefix="/u/scratch/d/diegoort/Trajs"$SGE_TASK_ID"/Traj"

time /u/home/d/diegoort/klohmueldata/diego_data/OldGeneralDirectory/project/Programs/Modified_mbs/mbs 3 -t 0.002 -r 0.002 -s 500000 1 -f ${NumberOfMarkers[$i]} 1 $TrajPrefix > $MsselOutNoRec
