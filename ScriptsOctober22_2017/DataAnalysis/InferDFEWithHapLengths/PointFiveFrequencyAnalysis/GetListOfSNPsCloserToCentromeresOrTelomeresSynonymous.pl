...
open (FREQ,"../../../../Data/Plink/AllSynonymousPointFivePercent.frq") or die "NO!";
open (NUM,">../../../../Data/VariantNumberPointFiveSynonymous.txt") or die "NO!";
open (INC,">../../../../Data/VariantNumberPointFiveToIncludeSynonymous.txt") or die "NO!";
