...
ParameterFile="ParameterFile_DFE_"$i"_BHighPop.txt"

time perl ../../ConstantPopSize/ForwardSims/GetListOfRunsWhereFrequencyMatches.pl ${LowFreq[$i]} ${UpFreq[$i]} ../../../../Results/UK10K/ForwardSims/DFETestHighPop/Output.$SLURM_ARRAY_TASK_ID.full_out.txt ../../../../Results/UK10K/ForwardSims/DFETestHighPop/$AlleleFile 0 24834
