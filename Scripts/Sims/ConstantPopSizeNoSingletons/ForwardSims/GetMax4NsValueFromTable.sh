...
for k in {3..3}
do
ResultsFile="../../../../Results/ConstantPopSize/ForwardSims/"${Dir[$i]}"/HapLengths/ExitFileNoRecNoSingletonN"${NumberOfMarkers[$k]}".txt"
cat ../../../../Results/ConstantPopSize/ForwardSims/${Dir[$i]}/HapLengths/ExitFileNoRecNoSingletonN${NumberOfMarkers[$k]}_{1..100}.txt > $ResultsFile
# DataSummarized="ResultsSelectionInferred/Selection"${Selection[$i]}"_N"${NumberOfMarkers[$k]}".txt"
DataSummarized="../../../../Results/ResultsSelectionInferred/SelectionConstantPopSizeNoSingleton"${Selection[$i]}"_N"${NumberOfMarkers[$k]}".txt"
perl ../../ConstantPopSize/ForwardSims/GetMax4NsValueFromTable.pl $ResultsFile $DataSummarized ${ActualSelection[$i]}
done
done
