...
DistancesFile="../../../../Results/UK10K/ForwardSims/4Ns_25/SimDistancesMsselSingleRecHighRecOnly72"${NumberOfMarkers[3]}"_"${RecRate[$RecNumber]}"_"$Repetition".txt"
rm $DistancesFile
touch $DistancesFile

for i in {69..76}
do
Value[$i]=$( grep 'age' ../../../../Results/UK10K/ForwardSims/4Ns_25/ReducedTrajectories_$i.txt | wc -l )
done
...
# for i in {69..76}
# do
HapLengths="../../../../Results/UK10K/ForwardSims/4Ns_25/HapLengthN"${NumberOfMarkers[3]}"_"${RecRate[$RecNumber]}"_"$Repetition".txt"
HapLengthsNoRec="../../../../Results/UK10K/ForwardSims/4Ns_25/HapLengthNoRecN"${NumberOfMarkers[3]}"_"${RecRate[$RecNumber]}"_"$Repetition".txt"
HapLengthsMultiSeq="../../../../Results/UK10K/ForwardSims/4Ns_25/HapLengthMultiSeqN"${NumberOfMarkers[3]}"_"${RecRate[$RecNumber]}"_"$Repetition".txt"
HapLengthsNoRecAnc="../../../../Results/UK10K/ForwardSims/4Ns_25/HapLengthNoRecAncN"${NumberOfMarkers[3]}"_"${RecRate[$RecNumber]}"_"$Repetition".txt"
HapLengthsRecAware="../../../../Results/UK10K/ForwardSims/4Ns_25/HapLengthRecAwareN"${NumberOfMarkers[3]}"_"${RecRate[$RecNumber]}"_"$Repetition".txt"
DistancesFileOne="../../../../Results/UK10K/ForwardSims/4Ns_25/SimDistancesPartOneMsselSingleRec"${NumberOfMarkers[3]}"_"${RecRate[$RecNumber]}"_"$Repetition".txt"
DistancesFileTwo="../../../../Results/UK10K/ForwardSims/4Ns_25/SimDistancesPartTwoMsselSingleRec"${NumberOfMarkers[3]}"_"${RecRate[$RecNumber]}"_"$Repetition".txt"
DistancesFileTemp="../../../../Results/UK10K/ForwardSims/4Ns_25/SimDistancesMsselSingleRecHighRecOnly72Temp"${NumberOfMarkers[3]}"_"${RecRate[$RecNumber]}"_"$Repetition".txt"

perl ../../ConstantPopSize/ForwardSims/SampleTrajectories.pl ../../../../Results/UK10K/ForwardSims/4Ns_25/ReducedTrajectories_72.txt 275 $ResampledTrajFile $Repetition
