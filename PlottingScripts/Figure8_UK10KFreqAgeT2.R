...
############### Population scenarios
	...
	if (j==12){
		...
		plot(c(100000,100000-46,100000-(46+244),100000-(61+229+352),100000-(61+229+352+1221),100000-(61+229+352+1221+22971)),c(226252/2,1496/2,1171/2,9109/2,4594/2,14600/2),type="s",xlim=c(100000-3000,100000),ylim=c(0,226252/2),ylab="Effective Population Size",xlab="Time before the present",main="A) UK10K Model",xaxt='n',yaxt='n',cex.main=2.5,cex.lab=2.5,col="red",lwd=6)
