...
$ExitFile = "../../../Data/Plink/HapLengths/HapLengthOnlyCpG".$SNPNumberToTake.".txt";
open (EXIT,">$ExitFile") or die "NO!";
### Get Position and chromosome number associated

open (FILE,"../../../Data/Plink/MissenseOnePercentCpG.frq") or die "NO!";
@Positions = ();
@Chromosomes = ();
@AncestralAllele = ();
@AlleleZero = ();
...
$PositionFile="../../../Data/Plink/PositionsNotCpG".$Chromosomes[$SNPNumberToTake].".txt";
...
$PlinkTpedFile = "../../../Data/Plink/PlinkNotCpG".$Chromosomes[$SNPNumberToTake].".tped";
