...
ExitMssel="../../../../../Results/UK10K/ImportanceSamplingSimsErrorRate"${ErrorRate[$ErrorRateValue]}"MutRate"${MutRate[$MutRateValue]}"/TrajParTrajPartMsselOut_"$FileNumber".txt"
MsselFile="../../../../../Results/UK10K/ImportanceSamplingSimsErrorRate"${ErrorRate[$ErrorRateValue]}"MutRate"${MutRate[$MutRateValue]}"/MsselFileOut_"$FileNumber".txt"
DistancesFile="../../../../../Results/UK10K/ImportanceSamplingSimsErrorRate"${ErrorRate[$ErrorRateValue]}"MutRate"${MutRate[$MutRateValue]}"/DistancesFile10000_"$FileNumber".txt"
...
../../../../../Programs/Mssel/mssel3 3 1000 1 2 $ExitMssel 1 -r 1989.25 250000 -t $ThetaValue -eN 0.0 1.0 -eN 0.0000867 0.1291653 -eN 0.0001768 0.0421744 -eN 0.0013261 0.0107298 -eN 0.0029405 0.0834516 -eN 0.0085331 0.0420890 -seeds $SeedNumber $SeedNumber $SeedNumber > $MsselFile
# done
