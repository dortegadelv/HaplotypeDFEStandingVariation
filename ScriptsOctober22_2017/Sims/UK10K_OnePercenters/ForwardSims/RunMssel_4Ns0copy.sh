...
TrajNum=$( wc -l ../../../../Results/UK10K/ForwardSims/4Ns_0/Alleles{1..300}.txt | tail -n1 | awk '{print $1}' )
echo $TrajNum
...
perl ../SampleTrajectories.pl ../../../../Results/UK10K/ForwardSims/4Ns_0/ReducedTrajectories.txt ${NumberOfMarkers[$i]} $ResampledTrajFile $SGE_TASK_ID
