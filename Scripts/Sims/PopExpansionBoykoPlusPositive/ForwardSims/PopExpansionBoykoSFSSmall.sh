...
time GSL_RNG_SEED=$SLURM_ARRAY_TASK_ID GSL_RNG_TYPE=mrg ../../../../Programs/PReFeRSim/fwd_seldist_gsl_2012_4epoch.debug ParameterFileBoykoSFSSmall.txt $SLURM_ARRAY_TASK_ID

# time perl ../../ConstantPopSize/ForwardSims/GetListOfRunsWhereFrequencyMatches.pl 0.01 0.01 ../../../../Results/PopExpansionMousePlusPositive/ForwardSims/MousePart/Output.$SLURM_ARRAY_TASK_ID.full_out.txt ../../../../Results/PopExpansionMousePlusPositive/ForwardSims/MousePart/Alleles_$SLURM_ARRAY_TASK_ID.txt 0 80100

# File="../../../../Results/PopExpansionMousePlusPositive/ForwardSims/MousePart/Output."$SLURM_ARRAY_TASK_ID".full_out.txt"
