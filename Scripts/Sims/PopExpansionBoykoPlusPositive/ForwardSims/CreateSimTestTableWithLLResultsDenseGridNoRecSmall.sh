...
ResultsFile="../../../../Results/PopExpansionBoykoPlusPositive/ForwardSims/BoykoPart/HapLengths/ExitFileNoRecSmallN"$i".txt"
rm $ResultsFile

perl ../../ConstantPopSize/ForwardSims/CalculatePLengthGivenS.pl $HapFile 250000 ../../../../Results/PopExpansionBoykoPlusPositive/ImportanceSampling/DFETableToTestSmall.txt ../ImportanceSamplingSims/TestT2Bounds.txt $ResultsFile
done
