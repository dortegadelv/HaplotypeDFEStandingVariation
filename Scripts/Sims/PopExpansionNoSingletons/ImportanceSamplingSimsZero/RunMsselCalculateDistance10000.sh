...
File="../../../../Results/PopExpansionZero/ImportanceSamplingSims/ExitMssel_0.01_0_"$FileNumber".txtTrajectory.txt"
ExitMssel="../../../../Results/PopExpansionZero/ImportanceSamplingSims/TrajParTrajPartMsselOut_"$FileNumber"_"$Repetition".txt"
MsselFile="../../../../Results/PopExpansionZero/ImportanceSamplingSims/MsselFileOut_"$FileNumber"_"$Repetition".txt"
DistancesFile="../../../../Results/PopExpansionZero/ImportanceSamplingSims/DistancesFile10000_"$FileNumber"_"$Repetition".txt"
...
for i in {1..1000}
do
perl ../../ConstantPopSize/ImportanceSamplingSims/TrajectoryPartMssel.pl $File $i $ExitMssel 9234
...
# for k in {1..1000}
# do
../../../../Programs/Mssel/mssel3 41 100 1 40 $ExitMssel 1 -r 0.0 250000 -t 640.620000000000000 -eN 0.0 1.0 -eN .000585370422403 .068511754238081 -seeds $SeedNumber $SeedNumber $SeedNumber > $MsselFile
# done
