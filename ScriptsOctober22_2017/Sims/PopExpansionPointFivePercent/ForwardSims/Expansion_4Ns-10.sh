...
time perl ../../../ConstantPopSize/ForwardSims/GetListOfRunsWhereFrequencyMatches.pl 0.0099 0.00501 TestData/run.4/full_out.run.4.num.$SGE_TASK_ID.N.10000.h.0.500000.F.0.000000.txt TestData/run.4/Alleles$SGE_TASK_ID.txt 0 80100

time GSL_RNG_SEED=$SGE_TASK_ID GSL_RNG_TYPE=mrg ../fwd_seldist_gsl_2012_4epoch.debug -m1000 -t$SGE_TASK_ID -z4 -gpoint 0.0005 -f1.0 -h0.5 -F0.0 -n20 -RPopulationExpansionModel.txt -S0 -TTestData/run.4/Alleles$SGE_TASK_ID.txt TestData/run.4/Traj_0.005_$SGE_TASK_ID.txt TestData/
