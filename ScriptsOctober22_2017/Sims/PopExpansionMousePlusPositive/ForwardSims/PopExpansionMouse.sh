...
time perl ../../ConstantPopSize/ForwardSims/GetListOfRunsWhereFrequencyMatches.pl 0.01 0.01 ../../../../Results/PopExpansionMousePlusPositive/ForwardSims/MousePart/Output.$SGE_TASK_ID.full_out.txt ../../../../Results/PopExpansionMousePlusPositive/ForwardSims/MousePart/Alleles_$SGE_TASK_ID.txt 0 80100

File="../../../../Results/PopExpansionMousePlusPositive/ForwardSims/MousePart/Output."$SGE_TASK_ID".full_out.txt"
