...
File="../../../../Results/MediumBottleneck/ImportanceSamplingSims/ExitMssel_0.01_0_"$FileNumber".txtTrajectory.txt"
ExitMssel="../../../../Results/MediumBottleneck/ImportanceSamplingSims/TrajParTrajPartMsselOut_"$FileNumber"_"$Repetition".txt"
MsselFile="../../../../Results/MediumBottleneck/ImportanceSamplingSims/MsselFileOut_"$FileNumber"_"$Repetition".txt"
DistancesFile="../../../../Results/MediumBottleneck/ImportanceSamplingSims/DistancesFile10000_"$FileNumber"_"$Repetition".txt"
...
# for k in {1..1000}
# do
../../../../Programs/Mssel/mssel3 3 1000 1 2 $ExitMssel 1 -r 100 500000 -t 120 -eN 0.0 1.0 -eN 0.1 0.2 -eN 0.11 1.0 -seeds $SeedNumber $SeedNumber $SeedNumber > $MsselFile
# done
