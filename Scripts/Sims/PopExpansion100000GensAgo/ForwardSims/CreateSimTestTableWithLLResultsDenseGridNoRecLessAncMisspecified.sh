...
for k in {3..3}
do
ResultsFile="../../../../Results/PopExpansion/ForwardSims/"${FourNs[$i]}"/HapLengths/ExitFileNoRecLessAncestryMisspecifiedN"${NumberOfMarkers[$k]}"_"$Repetition".txt"
rm $ResultsFile
HapFile="../../../../Results/PopExpansion/ForwardSims/"${FourNs[$i]}"/HapLengths/HapLengthsLessAncestryMisspecified"$Repetition".txt"
