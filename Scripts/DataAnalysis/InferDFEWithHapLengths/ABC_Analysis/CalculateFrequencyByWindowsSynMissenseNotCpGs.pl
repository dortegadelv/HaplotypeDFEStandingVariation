...
$SynNumberFile = "../../../../Data/Plink/CpGSynOnePercentNumberPositionsVar.txt";
...
$SynNumberFile = "../../../../Data/Plink/CpGMisOnePercentNumberPositionsVar.txt";
open (SYNN,$SynNumberFile) or die "NO!";
while(<SYNN>){
chomp;
$Line = $_;
...
print "Number = $SynN\n";
$File = "../../../../Data/Plink/HapLengths/HapLengthSynonymousNotCpG".$SynN.".txt";
...
for $MisN (@MisNumbers){
print "Number = $MisN\n";
$File = "../../../../Data/Plink/HapLengths/HapLengthOnlyCpG".$MisN.".txt";
open (DIST,$File) or die "NO!";
