...
FileToCheck="../../../../Results/UK10K/ForwardSims/"${FourNs[$DirNumber]}"/SimDistancesMsselSingleRecHighRecHigherhMut273_"${RecRate[$RecNumber]}"_"$RepNumber".txt"
LLResults="../../../../Results/UK10K/ForwardSims/"${FourNs[$DirNumber]}"/LLSimsSingleRecHighRecHigherMutMssel273_"${RecRate[$RecNumber]}"_"$CurRecNumber"_"$RepNumber".txt"
echo "File = $FileToCheck"
CountDistancesFile="../../../../Results/UK10K/ForwardSims/"${FourNs[$DirNumber]}"/CountDistancesMsselSingleRecHighRecHigherMut273_"${RecRate[$RecNumber]}"_"$RepNumber".txt"
...
FileToCheck="../../../../Results/UK10K/ForwardSims/"${FourNs[$DirNumber]}"/SimDistancesMsselSingleRecHighRecLowerMut273_"${RecRate[$RecNumber]}"_"$RepNumber".txt"
LLResults="../../../../Results/UK10K/ForwardSims/"${FourNs[$DirNumber]}"/LLSimsSingleRecHighRecLowerMutMssel273_"${RecRate[$RecNumber]}"_"$CurRecNumber"_"$RepNumber".txt"
echo "File = $FileToCheck"
CountDistancesFile="../../../../Results/UK10K/ForwardSims/"${FourNs[$DirNumber]}"/CountDistancesMsselSingleRecHighRecLowerMut273_"${RecRate[$RecNumber]}"_"$RepNumber".txt"
