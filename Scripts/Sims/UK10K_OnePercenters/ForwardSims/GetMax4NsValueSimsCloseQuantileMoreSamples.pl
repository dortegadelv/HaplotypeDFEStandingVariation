...
$ExitFile = "../../../../Results/ResultsSelectionInferred/SelectionUK10KMoreSamples".$FourNs[$DirNumber].".txt";
open (EXIT,">$ExitFile") or die "NO";
for ( $RepNumber = 1; $RepNumber <= 100 ; $RepNumber++) {
$File="../../../../Results/UK10K/ForwardSims/".$FourNs[$DirNumber]."/LLSimsMsselCloserQuantile273_".$RepNumber.".txt";
...
for ($CurrentCheckedLine = 126; $CurrentCheckedLine < 277; $CurrentCheckedLine++){
