...
for k in {3..3}
do
ResultsFile="../../../../Results/ConstantPopSize/ForwardSims/"${FourNs[$i]}"/HapLengths/ExitFileNoRecLessAncestryMisspecifiedN"${NumberOfMarkers[$k]}"_"$Repetition".txt"
rm $ResultsFile
HapFile="../../../../Results/ConstantPopSize/ForwardSims/"${FourNs[$i]}"/HapLengths/HapLengthsLessAncestryMisspecified"$Repetition".txt"
