...
File="../../../../Results/ConstantPopSizeBoyko/ImportanceSampling/ExitMssel_0.01_0_"$FileNumber".txtTrajectory.txt"
ExitMssel="../../../../Results/ConstantPopSizeBoyko/ImportanceSampling/TrajParTrajPartMsselOut_"$FileNumber"_"$Repetition".txt"
MsselFile="../../../../Results/ConstantPopSizeBoyko/ImportanceSampling/MsselFileOut_"$FileNumber"_"$Repetition".txt"
DistancesFile="../../../../Results/ConstantPopSizeBoyko/ImportanceSampling/DistancesFile10000_"$FileNumber"_"$Repetition".txt"
...
for i in {1..1000}
do
perl ../../ConstantPopSize/ImportanceSamplingSims/TrajectoryPartMssel.pl $File $i $ExitMssel 10000
