...
MsselOutNoRec="../../../../Results/UK10K/ForwardSims/4Ns_-25/MsselOutNoRec"$SGE_TASK_ID".txt"
...
DistancesFileOne="../../../../Results/UK10K/ForwardSims/4Ns_-25/SimDistancesPartOneMssel"${NumberOfMarkers[$i]}"_"$SGE_TASK_ID".txt"
DistancesFileTwo="../../../../Results/UK10K/ForwardSims/4Ns_-25/SimDistancesPartTwoMssel"${NumberOfMarkers[$i]}"_"$SGE_TASK_ID".txt"
DistancesFile="../../../../Results/UK10K/ForwardSims/4Ns_-25/SimDistancesMssel"${NumberOfMarkers[$i]}"_"$SGE_TASK_ID".txt"


perl ../../ConstantPopSize/ForwardSims/SampleTrajectories.pl ../../../../Results/UK10K/ForwardSims/4Ns_-25/ReducedTrajectories10000.txt 611 $ResampledTrajFile $SGE_TASK_ID
