$ExitFile = "../../../../Results/ConstantPopSizePopFrequency/ImportanceSamplingSims/SumDistancesFile10000.txt";
...
for ( $k = 1; $k <= 10; $k++ ){
$InputFile = "../../../../Results/ConstantPopSizePopFrequency/ImportanceSamplingSims/DistancesFile10000_".$j."_".$k.".txt";
