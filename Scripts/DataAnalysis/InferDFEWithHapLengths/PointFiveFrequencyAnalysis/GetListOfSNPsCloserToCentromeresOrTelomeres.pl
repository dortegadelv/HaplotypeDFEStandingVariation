...
open (FREQ,"../../../../Data/Plink/AllMissensePointFivePercent.frq") or die "NO!";
open (NUM,">../../../../Data/VariantNumberPointFive.txt") or die "NO!";
open (INC,">../../../../Data/VariantNumberPointFiveToInclude.txt") or die "NO!";
