...
Line[12]="../../../Programs/Mssel/mssel3 4000 300 3960 40 $ResampledTrajectory 250000 -r 0.0 250000 -t 16968.9 -eN 0.0 1.0 -eN 0.0001017 0.0066121 -eN 0.0006409 0.0051756 -eN 0.0014188 0.0402604 -eN 0.0041171 0.0203048 -seeds $k $k $k"

${Line[$i]} > $MsselOut

#### Followed by

perl ConvertMsselToVCF.pl $MsselOut 4000 $PhasedDataPrefix
...
perl DistanceToFirstSegregatingSiteMultiSequence_NoSingletonsBothSides.pl $MsselOut $HapLengths 3960 40
# rm $MsselOut
