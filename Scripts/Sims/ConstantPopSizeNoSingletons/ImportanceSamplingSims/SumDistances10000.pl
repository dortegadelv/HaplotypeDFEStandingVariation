$ExitFile = "../../../../Results/ConstantPopSize/ImportanceSamplingSims/SumDistancesFileNS10000.txt";
...
for ( $k = 1; $k <= 1; $k++ ){
$InputFile = "../../../../Results/ConstantPopSize/ImportanceSamplingSims/DistancesFileNS10000_".$j."_".$k.".txt";
