$ExitFile = "../../../../Results/ConstantPopSize/ImportanceSamplingSims/SumDistancesFile10000_100Windows.txt";
...
for ( $k = 1; $k <= 1; $k++ ){
$InputFile = "../../../../Results/ConstantPopSize/ImportanceSamplingSims/DistancesFile10000_100Windows_".$j."_".$k.".txt";
