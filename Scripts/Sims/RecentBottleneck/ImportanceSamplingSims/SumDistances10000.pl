$ExitFile = "../../../../Results/RecentBottleneck/ImportanceSamplingSims/SumDistancesFile10000.txt";
...
for ( $k = 1; $k <= 10; $k++ ){
$InputFile = "../../../../Results/RecentBottleneck/ImportanceSamplingSims/DistancesFile10000_".$j."_".$k.".txt";
