...
ResampledTrajFile="../../../../Results/UK10K/ForwardSims/DFETestHighPop/ResampledTraj"$SGE_TASK_ID".txt"
MsselOut="../../../../Results/UK10K/ForwardSims/DFETestHighPop/MsselOut"$SGE_TASK_ID".txt"
HapLengths="../../../../Results/UK10K/ForwardSims/DFETestHighPop/HapLength"$SGE_TASK_ID".txt"
MsselOutNoRec="../../../../Results/UK10K/ForwardSims/DFETestHighPop/MsselOutNoRec"$SGE_TASK_ID".txt"
HapLengthsNoRec="../../../../Results/UK10K/ForwardSims/DFETestHighPop/HapLengthNoRec"$SGE_TASK_ID".txt"
MsselOutNoRecAnc="../../../../Results/UK10K/ForwardSims/DFETestHighPop/MsselOutNoRecAnc"$SGE_TASK_ID".txt"
HapLengthsNoRecAnc="../../../../Results/UK10K/ForwardSims/DFETestHighPop/HapLengthNoRecAnc"$SGE_TASK_ID".txt"

MsselOutMultiSeq="../../../../Results/UK10K/ForwardSims/DFETestHighPop/MsselOutMultiSeq"$SGE_TASK_ID".txt"
HapLengthsMultiSeq="../../../../Results/UK10K/ForwardSims/DFETestHighPop/HapLengthMultiSeq"$SGE_TASK_ID".txt"
T2File="../../../../Results/UK10K/ForwardSims/DFETestHighPop/T2Values"$SGE_TASK_ID".txt"
...
for i in {3..3}
do
HapLengths="../../../../Results/UK10K/ForwardSims/DFETestHighPop/HapLengthN"${NumberOfMarkers[$i]}"_"$SGE_TASK_ID".txt"
HapLengthsNoRec="../../../../Results/UK10K/ForwardSims/DFETestHighPop/HapLengthNoRecN"${NumberOfMarkers[$i]}"_"$SGE_TASK_ID".txt"
HapLengthsMultiSeq="../../../../Results/UK10K/ForwardSims/DFETestHighPop/HapLengthMultiSeqN"${NumberOfMarkers[$i]}"_"$SGE_TASK_ID".txt"
HapLengthsNoRecAnc="../../../../Results/UK10K/ForwardSims/DFETestHighPop/HapLengthNoRecAncN"${NumberOfMarkers[$i]}"_"$SGE_TASK_ID".txt"
HapLengthsRecAware="../../../../Results/UK10K/ForwardSims/DFETestHighPop/HapLengthRecAwareN"${NumberOfMarkers[$i]}"_"$SGE_TASK_ID".txt"
DistancesFileOne="../../../../Results/UK10K/ForwardSims/DFETestHighPop/SimDistancesPartOneMssel"${NumberOfMarkers[$i]}"_"$SGE_TASK_ID".txt"
DistancesFileTwo="../../../../Results/UK10K/ForwardSims/DFETestHighPop/SimDistancesPartTwoMssel"${NumberOfMarkers[$i]}"_"$SGE_TASK_ID".txt"
DistancesFile="../../../../Results/UK10K/ForwardSims/DFETestHighPop/SimDistancesMssel"${NumberOfMarkers[$i]}"_"$SGE_TASK_ID".txt"


perl ../../ConstantPopSize/ForwardSims/SampleTrajectories.pl ../../../../Results/UK10K/ForwardSims/DFETestHighPop/ReducedTrajectories10000.txt 273 $ResampledTrajFile $SGE_TASK_ID
