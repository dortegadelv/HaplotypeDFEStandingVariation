...
#$ -N ForWF
#$ -o ../../../../Results/PopExpansion/ForwardSims/4Ns_0/Trash
#$ -e ../../../../Results/PopExpansion/ForwardSims/4Ns_0/Trash
...
time perl ../../ConstantPopSize/ForwardSims/GetListOfRunsWhereFrequencyMatches.pl 0.01 0.01 ../../../../Results/PopExpansion/ForwardSims/4Ns_0/Output.$SGE_TASK_ID.full_out.txt ../../../../Results/PopExpansion/ForwardSims/4Ns_0/Alleles_$SGE_TASK_ID.txt 0 80100

File="../../../../Results/PopExpansion/ForwardSims/4Ns_0/Output."$SGE_TASK_ID".full_out.txt"
