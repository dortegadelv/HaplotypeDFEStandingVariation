$ExitFile = "../../../../Results/PopExpansion10000GensAgo/ImportanceSamplingSims/SumDistancesFile10000.txt";
...
for ( $k = 1; $k <= 1; $k++ ){
$InputFile = "../../../../Results/PopExpansion10000GensAgo/ImportanceSamplingSims/DistancesFile10000_".$j."_".$k.".txt";
