...
FileToCheck="../../../../Results/UK10K/ForwardSims/"${FourNs[$DirNumber]}"/SimDistancesMsselSingleRecHighRecOnly72273_"${RecRate[$RecNumber]}"_"$RepNumber".txt"
LLResults="../../../../Results/UK10K/ForwardSims/"${FourNs[$DirNumber]}"/LLSimsSingleRecHighRecMsselOnly72273_"${RecRate[$RecNumber]}"_"$RepNumber".txt"
echo "File = $FileToCheck"
CountDistancesFile="../../../../Results/UK10K/ForwardSims/"${FourNs[$DirNumber]}"/CountDistancesMsselSingleRecHighRecOnly72273_"${RecRate[$RecNumber]}"_"$RepNumber".txt"
