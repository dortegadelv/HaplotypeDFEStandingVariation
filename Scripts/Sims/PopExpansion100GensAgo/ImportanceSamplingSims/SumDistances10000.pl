$ExitFile = "../../../../Results/PopExpansion100GensAgo/ImportanceSamplingSims/SumDistancesFile10000.txt";
...
for ( $k = 1; $k <= 1; $k++ ){
$InputFile = "../../../../Results/PopExpansion100GensAgo/ImportanceSamplingSims/DistancesFile10000_".$j."_".$k.".txt";
