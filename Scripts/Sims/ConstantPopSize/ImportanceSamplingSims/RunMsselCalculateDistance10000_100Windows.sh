...
ExitMssel="../../../../Results/ConstantPopSize/ImportanceSamplingSims/TrajParTrajPartMsselOut_100Windows_"$FileNumber"_"$Repetition".txt"
MsselFile="../../../../Results/ConstantPopSize/ImportanceSamplingSims/MsselFileOut_100Windows_"$FileNumber"_"$Repetition".txt"
DistancesFile="../../../../Results/ConstantPopSize/ImportanceSamplingSims/DistancesFile10000_100Windows_"$FileNumber"_"$Repetition".txt"
