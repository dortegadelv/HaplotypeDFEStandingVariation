...
#$ -N ForWF
#$ -o ../../../../Results/AncientBottleneck/ForwardSims/4Ns_50/Trash
#$ -e ../../../../Results/AncientBottleneck/ForwardSims/4Ns_50/Trash
...
time perl ../../ConstantPopSize/ForwardSims/GetListOfRunsWhereFrequencyMatches.pl 0.01 0.01 ../../../../Results/AncientBottleneck/ForwardSims/4Ns_50/Output.$SGE_TASK_ID.full_out.txt ../../../../Results/AncientBottleneck/ForwardSims/4Ns_50/Alleles_$SGE_TASK_ID.txt 0 80100

File="../../../../Results/AncientBottleneck/ForwardSims/4Ns_50/Output."$SGE_TASK_ID".full_out.txt"
