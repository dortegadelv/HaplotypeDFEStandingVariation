$ExitFile = "../../../../Results/PopExpansion/ImportanceSamplingSims/SumDistancesFileBothSidesFullHap10000.txt";
...
for ( $k = 1; $k <= 1; $k++ ){
$InputFile = "../../../../Results/PopExpansion/ImportanceSamplingSims/DistancesFileBothSidesFullHap10000_".$j."_".$k.".txt";
