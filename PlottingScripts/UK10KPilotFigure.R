...
for (j in 12:12){
	...
	MaxFreq <- 0
	for (i in 1:5){
		TrajectoryFile <- paste("FrequencyTrajectories/OutMeanTraj",DemScenario[j],SelectionTraj[i],".txt",sep="")
	...
	MaxAge <- 0
	TrajectoryFile <- paste("AlleleAges/Ages",DemScenario[j],"_",SelectionTestAge[1],".txt",sep="")
	Data <- read.table(TrajectoryFile)
	Max <- max(density(Data$V1*Ne[j]*2,from=0,to=quantile(Data$V1*Ne[j]*2,0.99))$x)
	for (i in 1:5){
		TrajectoryFile <- paste("AlleleAges/Ages",DemScenario[j],"_",SelectionTestAge[i],".txt",sep="")
		Data <- read.table(TrajectoryFile)
...
par(mar=c(5,5,5,2) + 0.1)
	...
	TrajectoryFile <- paste("FrequencyTrajectories/OutMeanTraj",DemScenario[j],SelectionTraj[1],".txt",sep="")
	Data <- read.table(TrajectoryFile)
...
#lines(Data$V1[10000:1],ISData$V2[1:10000],lwd=10,col=rgb(Color[1,1],Color[2,1],Color[3,1],100,maxColorValue=255))
	...
	TrajectoryFile <- paste("FrequencyTrajectories/OutMeanTraj",DemScenario[j],SelectionTraj[2],".txt",sep="")
	Data <- read.table(TrajectoryFile)
...
#lines(Data$V1[10000:1],ISData$V3[1:10000],lwd=10,col=rgb(Color[1,1],Color[2,1],Color[3,1],100,maxColorValue=255))
	...
	TrajectoryFile <- paste("FrequencyTrajectories/OutMeanTraj",DemScenario[j],SelectionTraj[3],".txt",sep="")
	Data <- read.table(TrajectoryFile)
...
#lines(Data$V1[10000:1],ISData$V4[1:10000],lwd=10,col=rgb(Color[1,1],Color[2,1],Color[3,1],100,maxColorValue=255))
	...
	TrajectoryFile <- paste("FrequencyTrajectories/OutMeanTraj",DemScenario[j],SelectionTraj[4],".txt",sep="")
	Data <- read.table(TrajectoryFile)
...
#lines(Data$V1[5000:1],Data$V4[1:5000],lty=3,col="red")
	...
	TrajectoryFile <- paste("FrequencyTrajectories/OutMeanTraj",DemScenario[j],SelectionTraj[5],".txt",sep="")
	Data <- read.table(TrajectoryFile)
...
#legend("topleft",c("0","-50","-100","50","100"),pch=19,col=c("black","purple","orange","red","dodgerblue"),cex=1.5,title="4Ns",bty="n")
	...
	AgesFile <- paste("AlleleAges/Ages",DemScenario[j],"_",SelectionTestAge[1],".txt",sep="")
...
#		abline(v=max(density(Data$V1*Ne[j]*2,from=0,to=Max)$x)-300,lty=3,lwd=3)
	...
	AgesFile <- paste("AlleleAges/Ages",DemScenario[j],"_",SelectionTestAge[2],".txt",sep="")
	Data <- read.table(AgesFile)
...
#	abline(v=mean(Max - Data$V1*Ne[j]*2),lwd=6,col=ColorViridisAlpha[2])
	...
	AgesFile <- paste("AlleleAges/Ages",DemScenario[j],"_",SelectionTestAge[3],".txt",sep="")
	Data <- read.table(AgesFile)
...
#abline(v=mean(Max - Data$V1*Ne[j]*2),lwd=6,col=ColorViridisAlpha[1])
	...
	AgesFile <- paste("AlleleAges/Ages",DemScenario[j],"_",SelectionTestAge[4],".txt",sep="")
	Data <- read.table(AgesFile)
...
#	StartingYValue <- length(density(Data$V1*Ne[j]*2,from=0,to=Max)$x) - Check
	...
	AgesFile <- paste("AlleleAges/Ages",DemScenario[j],"_",SelectionTestAge[5],".txt",sep="")
	Data <- read.table(AgesFile)
	Breaks <- seq(from=0,to=max(Data$V1*Ne[j]*2+50),by=50)
	Histogram <- hist(Data$V1*2*Ne[j],breaks=Breaks,plot=FALSE)
